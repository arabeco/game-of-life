...
Draw-CenterText -Graphics $graphics -Text "Energia dispersa`nparece esfor${ccedilla}o." -Font $titleLargeFont -Brush $goldBrushSlide -X 236 -Y 360 -Width 608 -Height 138
Draw-CenterText -Graphics $graphics -Text "Mas esfor${ccedilla}o espalhado vira`nru${iacute}do, troca de contexto`ne ansiedade." -Font $bodyFont -Brush $offWhiteBrush -X 256 -Y 548 -Width 568 -Height 118
Draw-CenterText -Graphics $graphics -Text "A m${eacute}dia chama isso`nde produtividade." -Font $bodySmallFont -Brush $mutedBrush -X 280 -Y 694 -Width 520 -Height 62
Draw-CenterText -Graphics $graphics -Text "Movimento n${atilde}o ${eacute} avan${ccedilla}o." -Font $titleMediumFont -Brush $whiteBrush -X 246 -Y 774 -Width 588 -Height 74
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Gente de elite`nconcentra for${ccedilla}a." -Font $titleLargeFont -Brush $goldBrushSlide -X 228 -Y 356 -Width 624 -Height 138
Draw-CenterText -Graphics $graphics -Text "Escolhe poucos alvos, repete`nfundamentos e sustenta press${atilde}o`nna mesma frente at${eacute} o`nresultado aparecer." -Font $bodyFont -Brush $offWhiteBrush -X 248 -Y 534 -Width 584 -Height 182
Draw-CenterText -Graphics $graphics -Text "Profundidade vence pressa." -Font $titleMediumFont -Brush $whiteBrush -X 252 -Y 786 -Width 576 -Height 70
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
