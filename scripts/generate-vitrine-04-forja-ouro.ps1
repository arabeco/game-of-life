...
Draw-Pill -Graphics $graphics -Text "Vitrine 04" -Font $bodyBoldFont -X 292 -Y 846 -Width 224 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "Vitrine 04  |  Forja e economia de ouro" -Font $eyebrowFont -Brush $eyebrowBrush -X 174 -Y 1060 -Width 732 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "VITRINE 04  |  FORJA E ECONOMIA DE OURO" -Font ([System.Drawing.Font]::new($headlineFamily, 44, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
