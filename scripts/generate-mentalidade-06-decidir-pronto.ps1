...
Draw-CenterText -Graphics $graphics -Text "Clareza raramente chega antes da a${ccedilla}${atilde}o.`nEla aparece no movimento." -Font $bodyFont -Brush $silverBrushSlide -X 170 -Y 720 -Width 740 -Height 116
...
Draw-CenterText -Graphics $graphics -Text "Confundem hesita${ccedilla}${atilde}o com prud${ecirc}ncia.`nTentam eliminar a n${eacute}voa antes de agir`ne transformam medo em m${eacute}todo." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Enquanto esperam, o tempo decide." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Decide com informa${ccedilla}${atilde}o suficiente, entra em movimento`ne refina a rota no percurso.`nA clareza vem durante, n${atilde}o antes." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Clareza ${eacute} fruto do avan${ccedilla}o." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
