param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\mentalidade-01-foco-seletivo\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Os melhores n${atilde}o`ntentam vencer em`n10 frentes ao`nmesmo tempo." -Font $heroTitleFont -Brush $goldBrushSlide -X 168 -Y 314 -Width 744 -Height 332
Draw-CenterText -Graphics $graphics -Text "Alta performance come${ccedilla}a no que voc${ecirc}`nescolhe n${atilde}o perseguir." -Font $bodyFont -Brush $silverBrushSlide -X 214 -Y 694 -Width 652 -Height 84
Draw-Pill -Graphics $graphics -Text "Mentalidade 01" -Font $bodyBoldFont -X 392 -Y 822 -Width 296 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Sele${ccedilla}${atilde}o" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 160 -Y 276 -Width 760 -Height 640
Draw-CenterText -Graphics $graphics -Text "Energia dispersa`nparece esfor${ccedilla}o." -Font $titleLargeFont -Brush $goldBrushSlide -X 184 -Y 336 -Width 712 -Height 178
Draw-CenterText -Graphics $graphics -Text "Mas esfor${ccedilla}o espalhado vira`nru${iacute}do, troca de contexto`ne ansiedade." -Font $bodyFont -Brush $silverBrushSlide -X 182 -Y 520 -Width 716 -Height 152
Draw-CenterText -Graphics $graphics -Text "A m${eacute}dia confunde ru${iacute}do com produtividade." -Font $bodySmallFont -Brush $mutedBrush -X 154 -Y 694 -Width 772 -Height 78
Draw-CenterText -Graphics $graphics -Text "Movimento n${atilde}o ${eacute} avan${ccedilla}o." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Press${atilde}o" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 156 -Y 276 -Width 768 -Height 640
Draw-CenterText -Graphics $graphics -Text "Gente de elite`nconcentra for${ccedilla}a." -Font $titleLargeFont -Brush $goldBrushSlide -X 182 -Y 334 -Width 716 -Height 176
Draw-CenterText -Graphics $graphics -Text "Escolhe poucos alvos, repete`nfundamentos e sustenta press${atilde}o`nna mesma frente at${eacute} o`nresultado aparecer." -Font $bodyFont -Brush $silverBrushSlide -X 182 -Y 528 -Width 716 -Height 220
Draw-CenterText -Graphics $graphics -Text "Profundidade vence pressa." -Font $titleMediumFont -Brush $whiteBrush -X 182 -Y 798 -Width 716 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mentalidade 01  |  Foco seletivo" -Font $eyebrowFont -Brush $eyebrowBrush -X 220 -Y 1060 -Width 640 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MENTALIDADE 01  |  FOCO SELETIVO" -Font ([System.Drawing.Font]::new($headlineFamily, 42, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
