-- Bau lendario deixa de ser apelido do bau de temporada.
--
-- 'lendario' e 'season' caiam no mesmo ramo do case, entao o bau que o ciclo
-- entregava como "Lendario" era, na pratica, o bau de temporada: abria item
-- exclusivo de season sem a pessoa tocar em missao de season nenhuma.
--
-- Agora sao dois baus distintos:
--   lendario  T4 40% / T5 60%, pity 6  - topo dos itens normais
--   season    T4 60% / T5 40%, pity 5  - so item de temporada
--
-- A separacao do acervo veio de graca: o filtro is_season_exclusive =
-- (v_chest_type = 'season') ja exclui item de temporada do bau lendario.
