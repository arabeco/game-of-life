param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-12-a-busca-da-perfeia-a-o\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-12-a-busca-da-perfeia-a-o\assets"
...
$quoteText = "Eu nÃ£o fujo de um desafio.`nCorro em direÃ§Ã£o a ele."
$supportCore = "A ginasta que transformou perfeiÃ§Ã£o em fato histÃ³rico aos 14 anos."
$analysis1Title = "O que Nadia ComÄƒneci fez?"
$analysis1 = "Nadia ComÄƒneci chocou o mundo ao conquistar a primeira nota 10 da histÃ³ria da ginÃ¡stica olÃ­mpica.`nAquela nota nÃ£o foi sÃ³ uma vitÃ³ria. Foi um deslocamento de rÃ©gua em um esporte inteiro."
$analysis1Close = "Ela nÃ£o venceu dentro do padrÃ£o. Mudou o padrÃ£o."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque perfeiÃ§Ã£o costuma ser palavra simbÃ³lica. ComÄƒneci a transformou em placar real, diante do mundo, com disciplina e precisÃ£o incompatÃ­veis com a idade."
$analysis2Close = "Ela fez o impossÃ­vel caber em nÃºmeros."
...
Draw-Pill -Graphics $graphics -Text "Legado 12  |  Nadia ComÄƒneci" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "A Busca da`nPerfeiÃ§Ã£o" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 12  |  Nadia ComÄƒneci" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 12  |  A BUSCA DA PERFEIÃ§Ã£O" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
