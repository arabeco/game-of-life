...
-- 1. Inserir a Season Genesis (Corrigido: removido colunas description e theme que não existem no banco)
...
-- 2. Garantir que as missões existam no banco com os IDs corretos
-- Andarilho
