...
export const ACTIVE_GOLD_ITEM_PRICE_BY_ID = {
    ...
    item_garden_stone_1: 22,
    item_garden_plant_1: 24,
    item_border_2_001: 30,
    item_garden_stone_2: 32,
    item_garden_plant_2: 36,
    item_skin_2_003: 35,
    item_garden_stone_3: 38,
...
export const ACTIVE_GOLD_STORE_ITEMS = [
    ...
    { id: 'item_garden_stone_1', name: 'Pedra Serena', category: 'artifact', tier: 1, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_garden_stone_1 },
    { id: 'item_garden_plant_1', name: 'Musgo Vivo', category: 'artifact', tier: 1, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_garden_plant_1 },
    { id: 'item_border_2_001', name: 'Popular', category: 'border', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_border_2_001 },
    { id: 'item_garden_stone_2', name: 'Pedra Lunar', category: 'artifact', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_garden_stone_2 },
    { id: 'item_garden_plant_2', name: 'Bambu Jovem', category: 'artifact', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_garden_plant_2 },
    { id: 'item_skin_2_003', name: 'Acadêmico', category: 'skin', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_2_003 },
    { id: 'item_garden_stone_3', name: 'Pedra Obsidiana', category: 'artifact', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_garden_stone_3 },
