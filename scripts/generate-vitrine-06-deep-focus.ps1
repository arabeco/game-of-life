...
Draw-CenterText -Graphics $graphics -Text "Quando chega a hora de executar,`no ambiente precisa expulsar ru${iacute}do`ne proteger uma s${oacute} miss${atilde}o." -Font $bodyFont -Brush $silverBrushSlide -X 142 -Y 642 -Width 796 -Height 196
Draw-Pill -Graphics $graphics -Text "Produto 06" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "O Deep Focus transforma inten${ccedilla}${atilde}o em presen${ccedilla}a.`nMenos ru${iacute}do visual, mais press${atilde}o elegante`npara ficar onde realmente importa." -Font $bodyFont -Brush $silverBrushSlide -X 176 -Y 676 -Width 728 -Height 236
...
Draw-CenterText -Graphics $graphics -Text "Produto 06  |  Deep Focus" -Font $eyebrowFont -Brush $eyebrowBrush -X 244 -Y 1060 -Width 592 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 06  |  DEEP FOCUS" -Font ([System.Drawing.Font]::new($headlineFamily, 44, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
