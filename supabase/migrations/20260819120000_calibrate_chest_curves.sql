-- Calibra as curvas de bau para a regua nova do ciclo.
--
-- Comum passa a ter cauda: 80/15/3/2 em vez de sempre T1. E o bau que todo
-- jogador abre, entao e nele que cabe o momento improvavel - dois tercos dos
-- jogadores leves veem um T4 por ano, o suficiente para virar historia sem
-- deixar de ser raro.
--
-- Radiante (Raro) perde o T5 e ganha T4: 40/45/15. Ele existe para entregar
-- raro, e o T5 que tinha em 5% transformava o ciclo de 7 dias no melhor farm
-- de lendario do jogo - 52 aberturas por ano batiam o ciclo mensal.
--
-- Com as duas mudancas o T4 por ano fica 1 / 2 / 3 / 6 conforme o esforco, e
-- o T5 segue fechado para quem nao faz ciclo longo com nota alta.
