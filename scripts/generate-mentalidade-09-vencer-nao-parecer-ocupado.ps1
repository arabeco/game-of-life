...
Draw-CenterText -Graphics $graphics -Text "O mediano se ofende.`nA elite extrai dado." -Font $bodyFont -Brush $offWhiteBrush -X 170 -Y 720 -Width 740 -Height 116
...
Draw-CenterText -Graphics $graphics -Text "Defendem a imagem, travam o corpo`ne desperdi${ccedilla}am informa${ccedilla}${atilde}o valiosa.`nO ego tenta sobreviver. A performance n${atilde}o cresce." -Font $bodyFont -Brush $offWhiteBrush -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Ego ferido bloqueia refinamento." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 844 -Width 728 -Height 110
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "N${atilde}o engolem tudo nem imploram aprova${ccedilla}${atilde}o.`nSeparam ru${iacute}do de sinal e usam fric${ccedilla}${atilde}o`npara lapidar execu${ccedilla}${atilde}o, postura e clareza." -Font $bodyFont -Brush $offWhiteBrush -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Cr${iacute}tica ${uacute}til vira combust${iacute}vel." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 856 -Width 728 -Height 112
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
