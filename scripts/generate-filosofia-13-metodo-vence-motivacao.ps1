param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\filosofia-13-metodo-vence-motivacao\\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Quando o tempo pesa,`nmétodo vence`nmotivação." -Font $heroTitleFont -Brush $marfimTitleBrush -X 140 -Y 302 -Width 800 -Height 314
Draw-CenterText -Graphics $graphics -Text "Vontade sobe e desce.`nSistema bem desenhado continua andando." -Font $bodyFont -Brush $offWhiteBrush -X 158 -Y 670 -Width 764 -Height 132
Draw-Pill -Graphics $graphics -Text "Filosofia 13" -Font $bodyBoldFont -X 404 -Y 824 -Width 272 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Fôlego" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 122 -Width 912 -Height 168
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 700 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Motivação acelera.`nMétodo sustenta." -Font $titleLargeFont -Brush $marfimTitleBrush -X 184 -Y 300 -Width 712 -Height 196
Draw-CenterText -Graphics $graphics -Text "No começo, entusiasmo empurra.`nNo longo prazo, só a estrutura aguenta repetição sem drama." -Font $bodyFont -Brush $offWhiteBrush -X 180 -Y 540 -Width 720 -Height 248
Draw-CenterText -Graphics $graphics -Text "Empolgação abre. Método conclui." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 838 -Width 728 -Height 120
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Peso" -Font $watermarkFont -Brush $goldWashBrush -X 80 -Y 118 -Width 920 -Height 176
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 708 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Quando a rotina endurece,`no ritual decide." -Font $titleLargeFont -Brush $marfimTitleBrush -X 176 -Y 294 -Width 728 -Height 198
Draw-CenterText -Graphics $graphics -Text "Dias comuns, cansaço e ruído expõem a diferença entre impulso e arquitetura.`nÉ aí que o método domina." -Font $bodyFont -Brush $offWhiteBrush -X 176 -Y 560 -Width 728 -Height 222
Draw-CenterText -Graphics $graphics -Text "O que é estruturado sobrevive ao atrito." -Font $titleMediumFont -Brush $whiteBrush -X 186 -Y 848 -Width 708 -Height 112
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Filosofia 13  |  Progresso sem registro vira ilusao" -Font $eyebrowFont -Brush $eyebrowBrush -X 132 -Y 1060 -Width 816 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FILOSOFIA 13  |  MÉTODO VENCE MOTIVAÇÃO QUANDO O TEMPO PESA" -Font ([System.Drawing.Font]::new($headlineFamily, 34, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
