param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-09-o-doce-estrata-gico\slides"
)
...
$coverSupport = "NÃ£o Ã© sobre demonizar prazer.`nÃ‰ sobre parar de ser governado por ele."
$logic1Title = "Beliscar o dia inteiro`ncobra mais."
$logic1Body = "Pequenas recompensas espalhadas parecem inofensivas, mas mantÃªm o corpo em busca constante de novo pico.`nIsso bagunÃ§a saciedade, foco e estabilidade energÃ©tica."
$logic1Close = "Pico frequente vira desgaste."
$logic2Title = "Prazer com contexto`nÃ© outra coisa."
$logic2Body = "Quando o doce entra em momento definido, sem culpa e sem repetiÃ§Ã£o caÃ³tica, ele deixa de comandar o resto do dia.`nEstratÃ©gia reduz impulsividade sem precisar de extremismo."
$logic2Close = "Controle nÃ£o exige proibiÃ§Ã£o total."
...
Draw-CenterText -Graphics $graphics -Text "O doce`nestratÃ©gico" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
Draw-CenterText -Graphics $graphics -Text $coverSupport -Font $bodyFont -Brush $offWhiteBrush -X 152 -Y 566 -Width 776 -Height 144
Draw-Pill -Graphics $graphics -Text "Fundamentos 09" -Font $bodyBoldFont -X 386 -Y 790 -Width 308 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Fundamentos 09  |  Descanso falso vs. descanso real" -Font $eyebrowFont -Brush $eyebrowBrush -X 98 -Y 1060 -Width 884 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 09  |  O DOCE ESTRATÃ©GICO" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
