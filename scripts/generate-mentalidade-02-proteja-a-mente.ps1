param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\mentalidade-02-proteja-a-mente\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Os melhores`nprotegem a`npr${oacute}pria mente." -Font $heroTitleFont -Brush $goldBrushSlide -X 168 -Y 314 -Width 744 -Height 332
Draw-CenterText -Graphics $graphics -Text "Clareza n${atilde}o nasce por acidente.`nEla ${eacute} defendida." -Font $bodyFont -Brush $silverBrushSlide -X 214 -Y 694 -Width 652 -Height 84
Draw-Pill -Graphics $graphics -Text "Mentalidade 02" -Font $bodyBoldFont -X 392 -Y 822 -Width 296 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Feed, dopamina curta e excesso`nde est${iacute}mulo cobram juros mentais`nno dia seguinte." -Font $bodyFont -Brush $silverBrushSlide -X 182 -Y 520 -Width 716 -Height 152
...
Draw-CenterText -Graphics $graphics -Text "Gente s${eacute}ria corta excesso antes`nde pedir mais disciplina.`nProtege sono, aten${ccedilla}${atilde}o e presen${ccedilla}a." -Font $bodyFont -Brush $silverBrushSlide -X 182 -Y 528 -Width 716 -Height 220
...
Draw-CenterText -Graphics $graphics -Text "Mentalidade 02  |  Proteja a mente" -Font $eyebrowFont -Brush $eyebrowBrush -X 220 -Y 1060 -Width 640 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MENTALIDADE 02  |  PROTEJA A MENTE" -Font ([System.Drawing.Font]::new($headlineFamily, 42, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
