...
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o era s${oacute} luta.`nEra presen${ccedilla}a, voz e destino." -Font $titleMediumFont -Brush $silverBrushSlide -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Ali n${Atilde}o venceu`ns${oacute} no ringue." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Transformou t${eacute}cnica, coragem e voz`np${uacute}blica em uma for${ccedilla}a`nimposs${iacute}vel de ignorar." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Talento chamava aten${ccedilla}${atilde}o.`nIdentidade sustentava impacto." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "F${iacute}sico`n10" -Body "O corpo virou`narma de presen${ccedilla}a,`nritmo e press${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Treino, repeti${ccedilla}${atilde}o`ne preparo at${eacute}`na confianca virar lei." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Prop${oacute}sito`n10" -Body "Lutava com voz,`nconvic${ccedilla}${atilde}o e uma`nidentidade imposs${iacute}vel`nde dobrar." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
...
Draw-CenterText -Graphics $graphics -Text "Muhammad Ali operava em voz, coragem,`npresen${ccedilla}a e convic${ccedilla}${atilde}o inegoci${aacute}vel." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
