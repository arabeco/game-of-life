...
Draw-CenterText -Graphics $graphics -Text "O mediano reage ao dia.`nA elite constr${oacute}i trajetoria." -Font $bodyFont -Brush $silverBrushSlide -X 170 -Y 720 -Width 740 -Height 116
...
Draw-CenterText -Graphics $graphics -Text "Se est${aacute}o inspirados, avan${ccedilla}am.`nSe est${atilde}o cansados, recuam.`nA vida inteira fica na m${atilde}o do estado interno." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Humor instavel gera destino fraco." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Aceitam oscila${ccedilla}${otilde}es, protegem dire${ccedilla}${atilde}o`ne continuam plantando mesmo sem aplauso imediato.`nDecada boa nasce de repeticao fria." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Pensa longo. Age hoje." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
