...
Draw-CenterText -Graphics $graphics -Text "Amador vê rotina.`nElite vê composição de força." -Font $bodyFont -Brush $silverBrushSlide -X 170 -Y 720 -Width 740 -Height 116
...
Draw-CenterText -Graphics $graphics -Text "O ganho raro não vem do gesto heroico isolado.`nVem da soma silenciosa do que foi bem feito muitas vezes." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Constância compõe capital." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Enquanto outros buscam novidade para sentir progresso,`nos melhores deixam o composto trabalhar." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Vantagem séria gosta de tempo." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
