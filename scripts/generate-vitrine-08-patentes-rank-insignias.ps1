param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\vitrine-08-patentes-rank-insignias\slides",
    [string]$Screen1Path = "",
    [string]$Screen2Path = ""
)
...
$proofRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round8\vitrine"
$proofFallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round8"
...
function Get-PrintLabel {
    ...
    switch ($base) {
        ...
        "patentes" { return "Patentes" }
        "levelup" { return "Level Up" }
...
Draw-CenterText -Graphics $graphics -Text "Patentes" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 132 -Width 912 -Height 180
Draw-CenterText -Graphics $graphics -Text "De Vagante`na Soberano." -Font $heroTitleFont -Brush $goldBrushSlide -X 134 -Y 362 -Width 812 -Height 206
Draw-CenterText -Graphics $graphics -Text "No GLYPH, progresso social n${atilde}o fica abstrato.`nEle sobe em 10 patentes reais." -Font $bodyFont -Brush $silverBrushSlide -X 142 -Y 642 -Width 796 -Height 196
Draw-Pill -Graphics $graphics -Text "Produto 08" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
Draw-Pill -Graphics $graphics -Text "Patentes" -Font $bodyBoldFont -X 536 -Y 858 -Width 248 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "Patentes" -Font $watermarkFont -Brush $goldWashBrush -X 86 -Y 118 -Width 908 -Height 180
...
Draw-CenterText -Graphics $graphics -Text "Seu n${iacute}vel`nprecisa aparecer." -Font $titleLargeFont -Brush $goldBrushSlide -X 196 -Y 384 -Width 688 -Height 236
Draw-CenterText -Graphics $graphics -Text "S${atilde}o 10 patentes vis${iacute}veis,`nde Vagante a Soberano.`nA execu${ccedilla}${atilde}o sobe de patente e ganha peso social." -Font $bodyFont -Brush $silverBrushSlide -X 176 -Y 676 -Width 728 -Height 236
Draw-CenterText -Graphics $graphics -Text "Status vis${iacute}vel gera tracao." -Font $titleSmallFont -Brush $whiteBrush -X 174 -Y 936 -Width 732 -Height 84
...
for ($proofPage = 0; $proofPage -lt $proofPageCount; $proofPage++) {
    ...
    $graphics = $canvas.Graphics
    Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgSapphire -Width $width -Height $height -Tone "safira"
    Draw-CenterText -Graphics $graphics -Text "Telas reais das`nPatentes." -Font $titleLargeFont -Brush $goldBrushSlide -X 124 -Y 150 -Width 832 -Height 110
...
Draw-CenterText -Graphics $graphics -Text "Produto 08  |  Patentes de Vagante a Soberano" -Font $eyebrowFont -Brush $eyebrowBrush -X 144 -Y 1060 -Width 792 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 08  |  PATENTES DE VAGANTE A SOBERANO" -Font ([System.Drawing.Font]::new($headlineFamily, 38, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
