...
public class StoreBillingPlugin extends Plugin implements PurchasesUpdatedListener {
    ...
    public void getProduct(PluginCall call) {
        ...
        if (productType == null) {
            call.reject("kind invalido", "INVALID_PRODUCT_KIND");
            return;
        }
        ...
        ensureConnection(
            () -> querySingleProduct(
                ...
                (billingResult, productDetailsResult) -> {
                    ...
                    ProductDetails productDetails = products.get(0);
    ...
    private void querySingleProduct(
        String productId,
        String productType,
        com.android.billingclient.api.ProductDetailsResponseListener listener
    ) {
