...
// ==========================================
// CONFIGURAÃ‡ÃƒO DO JOGO (GM BOARD)
// ==========================================

export const MAX_CLAN_MEMBERS = 10;

// --- DEFINIÃ‡Ã•ES DE TIPOS (SEASON) ---
...
export const SEASONS: Record<string, SeasonConfig> = {
  'season-genesis-0': {
    id: 'season-genesis-0',
    name: 'GÃªnesis',
    description: 'O inÃ­cio de uma nova era. Desperte seu potencial.',
    ...
    quests: [
      {
        id: 'quest-wanderer',
        title: 'O Andarilho',
        description: 'Caminhe 20km no total para fortalecer suas pernas e espÃ­rito. (Recompensa: 1 BaÃº Comum)',
        type: 'individual',
        category: 'physical',
        actionTemplate: { name: 'Caminhada (1km)', description: 'Caminhar 1km em ritmo constante.', duration: 15, icon: 'ðŸ¥¾', repetitions: 20 },
      ...
      },
      {
        id: 'quest-scholar',
        title: 'O Erudito',
        description: 'Leia um livro inteiro ou dedique tempo consistente Ã  leitura. (Recompensa: 1 BaÃº Comum)',
        type: 'individual',
        category: 'intellectual',
        actionTemplate: { name: 'Leitura Focada', description: 'Ler um livro com atenÃ§Ã£o plena.', duration: 30, icon: 'ðŸ“–', repetitions: 15, isMilestone: true },
      ...
      },
      {
        id: 'quest-warrior',
        title: 'O Guerreiro',
        description: 'Complete 50 flexÃµes (total acumulado) para fortalecer seu corpo. (Recompensa: 1 BaÃº Comum)',
        type: 'individual',
        category: 'physical',
        actionTemplate: { name: 'FlexÃµes (x10)', description: 'Fazer 10 flexÃµes com boa forma.', duration: 5, icon: 'âš”ï¸', repetitions: 5 },
        requirements: { totalReps: 5 },
        rewards: { xp: 1125, gold: 0 }
      },
      {
        id: 'quest-tutorial-1',
        title: 'EstaÃ§Ã£o 1: Alicerce',
        description: 'Complete o primeiro nÃ­vel do tutorial para entender as bases do seu reino. (Recompensa: 500 XP)',
        type: 'individual',
        category: 'intellectual',
        actionTemplate: { name: 'Tutorial Alicerce', description: 'Visualizar as bases do sistema.', duration: 5, icon: 'ðŸ—ï¸', repetitions: 1, isMilestone: true },
        requirements: { milestone: true },
      ...
      {
        id: 'quest-tutorial-2',
        title: 'EstaÃ§Ã£o 2: Identidade',
        description: 'Complete o segundo nÃ­vel do tutorial e defina quem vocÃª Ã© neste mundo. (Recompensa: 500 XP)',
        type: 'individual',
        category: 'intellectual',
        actionTemplate: { name: 'Tutorial Identidade', description: 'Explorar sua identidade soberana.', duration: 5, icon: 'ðŸ‘¤', repetitions: 1, isMilestone: true },
        requirements: { milestone: true },
        rewards: { xp: 500, gold: 0 },
        tutorialLevel: 2
      },
      {
        id: 'quest-tutorial-3',
        title: 'EstaÃ§Ã£o 3: O Mundo',
        description: 'Complete o terceiro nÃ­vel do tutorial e conheÃ§a as fronteiras do seu domÃ­nio. (Recompensa: 500 XP)',
        type: 'individual',
        category: 'intellectual',
        actionTemplate: { name: 'Tutorial Mundo', description: 'Navegar pelos domÃ­nios externos.', duration: 5, icon: 'ðŸŒ', repetitions: 1, isMilestone: true },
        requirements: { milestone: true },
        rewards: { xp: 500, gold: 0 },
        tutorialLevel: 3
      },
      {
        id: 'quest-tutorial-4',
        title: 'EstaÃ§Ã£o 4: O Arquiteto',
        description: 'Complete o quarto nÃ­vel do tutorial e torne-se o mestre do seu destino. (Recompensa: 500 XP)',
        type: 'individual',
        category: 'intellectual',
        actionTemplate: { name: 'Tutorial Arquiteto', description: 'Dominar as ferramentas de criaÃ§Ã£o.', duration: 5, icon: 'ðŸ“', repetitions: 1, isMilestone: true },
        requirements: { milestone: true },
        rewards: { xp: 500, gold: 0 },
        tutorialLevel: 4
      },
      {
        ...
        description: 'O ClÃ£ deve acumular 50 horas de atividades conjuntas. (Recompensa: 1 BaÃº Comum)',
        type: 'clan',
        category: 'social',
        actionTemplate: { name: 'Socializar (1h)', description: 'Uma hora de presenÃ§a e vÃ­nculo.', duration: 60, icon: 'ðŸ—£ï¸', repetitions: 50 },
...
export const GM_CONFIG = {
  seasons: [
    { id: 'season_0', name: 'Season 0 - AquÃ¡rio', start_date: '2024-01-01', end_date: '2026-02-18', background_png_url: 'https://i.imgur.com/6c2z3uH.jpeg', lore_text: 'Um tempo de purificaÃ§Ã£o...', is_active: true }
  ] as Season[],
  seasonMissions: [
    { id: 'sm_1', season_id: 'season_0', title: 'O Peregrino', description: 'Correr um total de 50km. (Recompensa: 1 BaÃº Comum)', goal_type: 'km_run', goal_value: 50, reward_type: 'exp', reward_value: 2250 },
    { id: 'sm_2', season_id: 'season_0', title: 'O SÃ¡bio', description: 'Ler 1 livro completo. (Recompensa: 1 BaÃº Comum)', goal_type: 'books_read', goal_value: 1, reward_type: 'exp', reward_value: 1125 },
    { id: 'sm_3', season_id: 'season_0', title: 'O Monge', description: 'Meditar por 20 dias. (Recompensa: 1 BaÃº Comum)', goal_type: 'meditation_days', goal_value: 20, reward_type: 'exp', reward_value: 1800 },
  ] as SeasonMission[],
  seasonQuests: [
    {
      id: 'sq_1',
      title: 'O Andarilho',
      description: 'Andar 20 km no total. (Recompensa: 1 BaÃº Comum)',
      type: 'individual',
      category: 'physical',
      actionTemplate: {
        name: 'Andar 1km',
        description: 'ExecuÃ§Ã£o unitÃ¡ria da Quest do Andarilho.',
        icon: 'ðŸš¶',
        duration: 15,
        repetitions: 20,
      },
    ...
    },
    {
      id: 'sq_2',
      title: 'O Leitor',
      description: 'Ler 1 livro inteiro. (Recompensa: 1 BaÃº Comum)',
      type: 'individual',
      category: 'intellectual',
      actionTemplate: {
        name: 'Ler (30 min)',
        description: 'SessÃ£o de leitura focada.',
        icon: 'ðŸ“š',
        duration: 30,
        repetitions: 10,
      },
    ...
    },
    {
      id: 'sq_3',
      title: 'O Forte',
      description: 'NÃ£o perder um dia de academia. (Recompensa: 1 BaÃº Comum)',
      type: 'individual',
      category: 'physical',
      actionTemplate: {
        name: 'Academia (Marco)',
    ...
    },
    {
      ...
      description: 'Somar 50 horas em equipe. (Recompensa: 1 BaÃº Comum)',
      type: 'clan',
      category: 'social',
      actionTemplate: {
        name: 'Socializar (1h)',
        description: 'Uma hora de presenÃ§a e vÃ­nculo.',
        icon: 'ðŸ—£ï¸',
        duration: 60,
        repetitions: 50,
      },
...
export const MOODS_DATA: Mood[] = [
    ...
    { label: "DisposiÃ§Ã£o", min: 60, max: 65, color: "linear-gradient(90deg, #3dbf8a, #50d09c)", trackStart: "#3dbf8a", trackEnd: "#50d09c" },
    { label: "AceitaÃ§Ã£o", min: 65, max: 70, color: "linear-gradient(90deg, #2bb3b3, #3ac6c6)", trackStart: "#2bb3b3", trackEnd: "#3ac6c6" },
    { label: "RazÃ£o", min: 70, max: 75, color: "linear-gradient(90deg, #2a7bd4, #3a93e6)", trackStart: "#2a7bd4", trackEnd: "#3a93e6" },
    ...
    { label: "IluminaÃ§Ã£o", min: 95, max: 101, color: "linear-gradient(90deg, #b227b5, #d06ad8)", trackStart: "#b227b5", trackEnd: "#d06ad8" },
];
...
export const MASTERY_LEVEL_DESCRIPTIONS: Record<string, string[]> = {
  consciencia: [
    ...
    "Ã€s vezes sinto uma breve gratidÃ£o, mas o ceticismo domina.",
    "ComeÃ§o a praticar a atenÃ§Ã£o plena, mas me distraio facilmente.",
    "A gratidÃ£o se torna um hÃ¡bito diÃ¡rio, mesmo que forÃ§ado.",
    "Sinto uma conexÃ£o mais profunda com o momento presente.",
    "A paz interior surge com mais frequÃªncia em meu dia a dia.",
    "Vejo a interconexÃ£o de todas as coisas com clareza.",
    "A consciÃªncia plena Ã© meu estado natural, nÃ£o um esforÃ§o.",
    "Vivo em um estado de fluxo, uno com o momento presente."
  ],
  espiritualidade: [
    "Nego qualquer dimensÃ£o alÃ©m do material.",
    "Questiono a existÃªncia de algo maior, mas com ceticismo.",
    "Exploro diferentes filosofias, mas sem compromisso.",
    "Adoto uma prÃ¡tica espiritual, mas de forma irregular.",
    "Minha prÃ¡tica se torna consistente e significativa.",
    "Sinto uma presenÃ§a ou energia superior em minha vida.",
    "A fÃ© (ou confianÃ§a no universo) guia minhas decisÃµes.",
    "Experimento momentos de transcendÃªncia e unidade.",
    "Minha vida Ã© uma expressÃ£o da minha verdade espiritual.",
    "Sinto-me em comunhÃ£o constante com o divino/universo."
  ],
  'espaco-mental': [
    "Minha mente Ã© um caos de pensamentos negativos e reativos.",
    "ReconheÃ§o meus padrÃµes de pensamento, mas nÃ£o consigo mudÃ¡-los.",
    "ComeÃ§o a desafiar crenÃ§as limitantes com algum sucesso.",
    "Pratico tÃ©cnicas para acalmar a mente, como meditaÃ§Ã£o.",
    "Consigo observar meus pensamentos sem me identificar com eles.",
    "Escolho conscientemente minhas reaÃ§Ãµes em vez de ser reativo.",
    "Minha mente se torna uma ferramenta a meu serviÃ§o, nÃ£o meu mestre.",
    "Cultivo clareza e foco com facilidade.",
    "A paz mental Ã© meu estado padrÃ£o, mesmo em meio ao caos.",
    "Minha mente Ã© um santuÃ¡rio de criatividade e sabedoria."
  ],
  projetos: [
    "Tenho ideias, mas nunca comeÃ§o nada.",
    "ComeÃ§o projetos, mas desisto na primeira dificuldade.",
    "Consigo completar pequenos projetos com muito esforÃ§o.",
    "Aprendo a planejar e organizar minhas ideias de forma eficaz.",
    "Executo projetos de mÃ©dio prazo com consistÃªncia.",
    "A criatividade flui e encontro soluÃ§Ãµes inovadoras.",
    "Colaboro efetivamente com outros para realizar grandes visÃµes.",
    "Meus projetos impactam positivamente minha vida e a dos outros.",
    "Sou uma fonte de inspiraÃ§Ã£o e realizaÃ§Ã£o criativa.",
    "Manifesto minhas visÃµes no mundo com maestria e propÃ³sito."
  ],
  proposito: [
    "Sinto-me perdido, sem direÃ§Ã£o ou sentido na vida.",
    "Busco um propÃ³sito, mas sinto que nada me preenche.",
    "Identifico meus valores, mas nÃ£o sei como aplicÃ¡-los.",
    "Experimento diferentes caminhos em busca de alinhamento.",
    "Defino uma missÃ£o de vida que ressoa com minha verdade.",
    "Minhas aÃ§Ãµes diÃ¡rias comeÃ§am a refletir minha missÃ£o.",
    "Meu trabalho e vida pessoal estÃ£o alinhados com meu propÃ³sito.",
    "Sinto uma profunda sensaÃ§Ã£o de significado e contribuiÃ§Ã£o.",
    "Inspiro outros a encontrarem e viverem seus propÃ³sitos.",
    "Minha vida Ã© a personificaÃ§Ã£o do meu propÃ³sito."
  ],
  conexoes: [
    "Sinto-me isolado e desconectado dos outros.",
    "Tenho relacionamentos superficiais e baseados em necessidade.",
    "ComeÃ§o a praticar a escuta ativa e a empatia.",
    "EstabeleÃ§o limites saudÃ¡veis em meus relacionamentos.",
    "Cultivo amizades genuÃ­nas e de apoio mÃºtuo.",
    "Sou capaz de expressar amor e vulnerabilidade de forma autÃªntica.",
    "Meus relacionamentos sÃ£o fontes de crescimento e alegria.",
    "Crio uma comunidade forte e unida ao meu redor.",
    "Minhas conexÃµes transcendem o ego e se baseiam na alma.",
    "Sou um catalisador de amor e uniÃ£o no mundo."
  ],
  financas: [
    "Estou constantemente endividado e ansioso com dinheiro.",
    "Consigo pagar as contas, mas vivo de salÃ¡rio em salÃ¡rio.",
    "Crio um orÃ§amento e comeÃ§o a controlar meus gastos.",
    "Construo uma reserva de emergÃªncia e quito dÃ­vidas ruins.",
    "ComeÃ§o a investir para o futuro de forma consistente.",
    "Minha renda passiva comeÃ§a a crescer.",
    "Tenho clareza sobre meus objetivos e plano financeiro.",
    "O dinheiro se torna uma ferramenta para liberdade e impacto.",
    "AlcanÃ§o a independÃªncia financeira.",
    "Uso minha riqueza para criar um legado e ajudar os outros."
  ],
  trabalho: [
    "Detesto meu trabalho e sinto-me estagnado.",
    "FaÃ§o o mÃ­nimo necessÃ¡rio para manter o emprego.",
    "Busco desenvolver novas habilidades, mas sem foco.",
    "Encontro um trabalho que se alinha melhor com meus interesses.",
    "Torno-me proficiente e valorizado em minha Ã¡rea.",
    "Encontro prazer e desafio no meu trabalho diÃ¡rio.",
    "Sou reconhecido como um especialista ou lÃ­der.",
    "Meu trabalho contribui para algo maior que eu.",
    "Inovo e crio valor de forma excepcional em minha carreira.",
    "Meu trabalho Ã© uma expressÃ£o de minha maestria e paixÃ£o."
  ],
  hobbies: [
    "NÃ£o tenho tempo ou energia para hobbies.",
    "Meus hobbies sÃ£o passivos, como assistir TV.",
    "Experimento novas atividades, mas nada me prende.",
    "Encontro um hobby que me desafia e me dÃ¡ prazer.",
    "Dedico tempo regularmente para minhas paixÃµes.",
    "Atinjo um nÃ­vel de habilidade que me orgulha.",
    "Meus hobbies sÃ£o uma fonte de relaxamento e criatividade.",
    "Conecto-me com outras pessoas atravÃ©s dos meus interesses.",
    "Meus hobbies se tornam uma parte essencial da minha identidade.",
    "AlcanÃ§o um estado de fluxo e maestria em minhas paixÃµes."
  ],
  fisico: [
    "Negligencio completamente minha saÃºde fÃ­sica.",
    "Tenho hÃ¡bitos prejudiciais (mÃ¡ alimentaÃ§Ã£o, sedentarismo).",
    "Tento me exercitar e comer melhor, mas sou inconsistente.",
    "Adoto uma rotina de exercÃ­cios e alimentaÃ§Ã£o mais saudÃ¡vel.",
    "Meu corpo se torna mais forte, flexÃ­vel e com mais energia.",
    "O bem-estar fÃ­sico se torna um pilar da minha vida.",
    "Escuto meu corpo e atendo Ã s suas necessidades com sabedoria.",
    "Supero meus limites e atinjo metas fÃ­sicas desafiadoras.",
    "Meu corpo Ã© um templo de vitalidade e alto desempenho.",
    "Irradio saÃºde e inspiro outros a cuidarem de si mesmos."
  ],
  geral: [],
};
...
export const ASSETS_DATA: Asset[] = [
  {
    id: 'consciencia', name: 'CONSCIÃŠNCIA', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.consciencia.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
      { id: 'consciencia.lema', label: 'LEMA', type: 1, inputType: 'textarea', value: 'Valor 1' },
      { id: 'consciencia.crenca1', label: 'CRENÃ‡A 1', type: 1, inputType: 'textarea', value: 'Valor 2' },
      { id: 'consciencia.crenca2', label: 'CRENÃ‡A 2', type: 1, inputType: 'textarea', value: 'Valor 3' },
      { id: 'consciencia.crenca3', label: 'CRENÃ‡A 3', type: 1, inputType: 'textarea', value: 'Valor 4' },
    ]
  },
  {
    id: 'espiritualidade', name: 'ESPIRITUALIDADE', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.espiritualidade.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
      { id: 'espiritualidade.sistema', label: 'Sistema Espiritual', type: 1, inputType: 'wheelpick', options: ['Cristianismo', 'Islamismo', 'Budismo', 'HinduÃ­smo', 'JudaÃ­smo', 'TaoÃ­smo', 'Gnosticismo', 'Espiritualismo', 'Agnosticismo', 'AteÃ­smo'], value: 'Agnosticismo' },
      { id: 'espiritualidade.santuario1', label: 'SantuÃ¡rio 1', type: 2, inputType: 'image', value: emptyImage },
      { id: 'espiritualidade.santuario2', label: 'SantuÃ¡rio 2', type: 2, inputType: 'image', value: emptyImage },
      { id: 'espiritualidade.santuario3', label: 'SantuÃ¡rio 3', type: 2, inputType: 'image', value: emptyImage },
    ]
  },
  {
    id: 'espaco-mental', name: 'ESPAÃ‡O MENTAL', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS['espaco-mental'].reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
  ...
  },
  {
    id: 'projetos', name: 'PROJETOS', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.projetos.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
      ...
      { id: 'projetos.inspiracao1', label: 'InspiraÃ§Ã£o 1', type: 2, inputType: 'image', value: emptyImage },
      { id: 'projetos.inspiracao2', label: 'InspiraÃ§Ã£o 2', type: 2, inputType: 'image', value: emptyImage },
      { id: 'projetos.inspiracao3', label: 'InspiraÃ§Ã£o 3', type: 2, inputType: 'image', value: emptyImage },
    ]
  },
  {
    id: 'proposito', name: 'PROPÃ“SITO', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.proposito.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
      { id: 'proposito.missao', label: 'MissÃ£o de Vida', type: 1, inputType: 'textarea', value: 'Minha missÃ£o...' },
      ...
      { id: 'proposito.personalidade2', label: 'Signo', type: 3, inputType: 'wheelpick', options: ['Ãries', 'Touro', 'GÃªmeos', 'CÃ¢ncer', 'LeÃ£o', 'Virgem', 'Libra', 'EscorpiÃ£o', 'SagitÃ¡rio', 'CapricÃ³rnio', 'AquÃ¡rio', 'Peixes'], value: 'Ãries' },
      { id: 'proposito.virtude1', label: 'Virtude 1', type: 3, inputType: 'wheelpick', options: ['Coragem', 'Honestidade', 'CompaixÃ£o', 'Sabedoria', 'JustiÃ§a', 'TemperanÃ§a', 'ResiliÃªncia', 'Humildade', 'PaciÃªncia', 'GratidÃ£o', 'Generosidade', 'Lealdade'], value: 'Coragem' },
      { id: 'proposito.virtude2', label: 'Virtude 2', type: 3, inputType: 'wheelpick', options: ['Coragem', 'Honestidade', 'CompaixÃ£o', 'Sabedoria', 'JustiÃ§a', 'TemperanÃ§a', 'ResiliÃªncia', 'Humildade', 'PaciÃªncia', 'GratidÃ£o', 'Generosidade', 'Lealdade'], value: 'Sabedoria' },
      { id: 'proposito.virtude3', label: 'Virtude 3', type: 3, inputType: 'wheelpick', options: ['Coragem', 'Honestidade', 'CompaixÃ£o', 'Sabedoria', 'JustiÃ§a', 'TemperanÃ§a', 'ResiliÃªncia', 'Humildade', 'PaciÃªncia', 'GratidÃ£o', 'Generosidade', 'Lealdade'], value: 'JustiÃ§a' },
    ]
  },
  {
    id: 'conexoes', name: 'CONEXÃ•ES', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.conexoes.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
  ...
  {
    id: 'financas', name: 'FINANÃ‡AS', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.financas.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
      ...
      { id: 'financas.luxos', label: 'Luxos', type: 3, inputType: 'wheelpick', options: ['Comer Bem', 'Conforto em Casa', 'Viagens e RolÃªs', 'EstÃ©tica e Shape', 'Pequenos Prazeres', 'Praticidade e Tecnologia', 'Mimar os Outros'], value: 'Comer Bem' },
  ...
  },
  {
    id: 'trabalho', name: 'TRABALHO/ESTUDOS', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.trabalho.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
      { id: 'trabalho.classe1_1', label: 'Classe 1', type: 3, inputType: 'wheelpick', options: ['MÃ©dico', 'Enfermeiro', 'Dentista', 'PsicÃ³logo', 'Engenheiro Civil', 'Engenheiro de Software', 'Advogado', 'Juiz', 'Professor', 'Designer GrÃ¡fico', 'UX/UI Designer', 'Criador de ConteÃºdo', 'Social Media', 'Gestor de TrÃ¡fego', 'Data Scientist', 'Atleta Profissional', 'Treinador', 'Empreendedor', 'Vendedor', 'Analista Financeiro', 'Contador', 'Chef de Cozinha', 'Arquiteto', 'FotÃ³grafo', 'Editor de VÃ­deo', 'MÃºsico', 'Escritor', 'Tradutor', 'ArtesÃ£o', 'Cientista'], value: 'Engenheiro de Software' },
      ...
      { id: 'trabalho.classe2_1', label: 'Classe 2', type: 3, inputType: 'wheelpick', options: ['MÃ©dico', 'Enfermeiro', 'Dentista', 'PsicÃ³logo', 'Engenheiro Civil', 'Engenheiro de Software', 'Advogado', 'Juiz', 'Professor', 'Designer GrÃ¡fico', 'UX/UI Designer', 'Criador de ConteÃºdo', 'Social Media', 'Gestor de TrÃ¡fego', 'Data Scientist', 'Atleta Profissional', 'Treinador', 'Empreendedor', 'Vendedor', 'Analista Financeiro', 'Contador', 'Chef de Cozinha', 'Arquiteto', 'FotÃ³grafo', 'Editor de VÃ­deo', 'MÃºsico', 'Escritor', 'Tradutor', 'ArtesÃ£o', 'Cientista'], value: 'UX/UI Designer' },
      ...
      { id: 'trabalho.experiencia1', label: 'ExperiÃªncia 1', type: 2, inputType: 'image', value: emptyImage },
      { id: 'trabalho.experiencia2', label: 'ExperiÃªncia 2', type: 2, inputType: 'image', value: emptyImage },
      { id: 'trabalho.experiencia3', label: 'ExperiÃªncia 3', type: 2, inputType: 'image', value: emptyImage },
    ]
  },
  {
  ...
  {
    id: 'fisico', name: 'FÃSICO', level: 0, levelDescriptions: MASTERY_LEVEL_DESCRIPTIONS.fisico.reduce((acc, desc, i) => ({ ...acc, [i+1]: desc }), {}), arenas: [], slots: [
      { id: 'fisico.basico1', label: 'Idade', type: 3, inputType: 'slider', range: { min: 15, max: 99 }, value: 25 },
      { id: 'fisico.basico2', label: 'GÃªnero', type: 3, inputType: 'wheelpick', options: ['Masculino', 'Feminino', 'NÃ£o-binÃ¡rio', 'Outro'], value: 'Masculino' },
      ...
      { id: 'fisico.forma', label: 'Forma FÃ­sica', type: 1, inputType: 'wheelpick', options: ['SedentÃ¡rio', 'Iniciante', 'IntermediÃ¡rio', 'AvanÃ§ado', 'Atleta'], value: 'Iniciante' },
      { id: 'fisico.medida3', label: 'Atributo', type: 4, inputType: 'wheelpick', options: ['ForÃ§a', 'Agilidade', 'InteligÃªncia', 'ResistÃªncia', 'Carisma', 'Sorte'], value: 'ForÃ§a' },
      { id: 'fisico.habito1', label: 'Atividade', type: 3, inputType: 'wheelpick', options: ['MusculaÃ§Ã£o', 'Corrida', 'NataÃ§Ã£o', 'Ciclismo', 'Crossfit', 'Yoga', 'Pilates', 'Artes Marciais', 'DanÃ§a', 'Esportes Coletivos', 'Calistenia', 'Caminhada'], value: 'MusculaÃ§Ã£o' },
      { id: 'fisico.habito2', label: 'Dieta', type: 3, inputType: 'wheelpick', options: ['Balanceada', 'OnÃ­vora', 'Vegetariana', 'Vegana', 'Low Carb', 'CetogÃªnica', 'Jejum Intermitente', 'FlexÃ­vel'], value: 'Balanceada' },
    ]
  },
  {
    id: 'geral',
    ...
    arenas: [
        { id: 'arena_outros', assetId: 'geral', name: 'Outros', description: 'Arena para aÃ§Ãµes gerais nÃ£o categorizadas.', icon: 'ðŸ—‚ï¸', actionIds: [] }
    ],
    slots: []
  },
];
