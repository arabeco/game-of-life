param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-04-o-poder-da-observacao-paciente\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-04-o-poder-da-observacao-paciente\assets"
...
$quoteText = "O que você faz`nfaz diferença.`nE você decide`nque diferença quer fazer."
$supportCore = "A pesquisadora que trocou pressa por décadas de observação até mudar a biologia."
$analysis1Title = "O que Jane Goodall fez?"
...
$analysis2Body = "Porque quase todo mundo quer resultado rápido. Goodall apostou na lentidão, na observação contínua e no acúmulo paciente até mudar uma área inteira."
...
Draw-CenterText -Graphics $graphics -Text "O Poder da Observação Paciente" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 04  |  O PODER DA OBSERVAÇÃO PACIENTE" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
