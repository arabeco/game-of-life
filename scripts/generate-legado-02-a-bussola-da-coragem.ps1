param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-02-a-bussola-da-coragem\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-02-a-bussola-da-coragem\assets"
...
$quoteText = "Todo grande sonho`ncomeça com um sonhador.`nVocê já carrega a força,`na paciência e a paixão."
$supportCore = "A mulher que fugiu da escravidão e voltou ao inferno para tirar outros de lá."
$analysis1Title = "O que Harriet Tubman fez?"
...
$analysis2Body = "Porque escapar já era improvável. Voltar repetidas vezes, sabendo o custo de ser capturada, é outro nível de coragem.`nTubman transformou sobrevivência em responsabilidade."
...
Draw-CenterText -Graphics $graphics -Text "A Bússola da Coragem" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 02  |  A BÚSSOLA DA CORAGEM" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
