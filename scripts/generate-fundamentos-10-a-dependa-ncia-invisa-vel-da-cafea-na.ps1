param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-10-a-dependa-ncia-invisa-vel-da-cafea-na\slides"
)
...
$coverSupport = "Nem sempre o cafÃ© Ã© problema.`nÃ€s vezes ele sÃ³ mascara outro."
$logic1Title = "EstÃ­mulo`npode esconder fadiga."
$logic1Body = "Se vocÃª precisa de cafeÃ­na para parecer funcional logo cedo, talvez o dÃ©ficit esteja no sono, na recuperaÃ§Ã£o ou na inflamaÃ§Ã£o diÃ¡ria do estilo de vida.`nO ritual vira muleta sem vocÃª perceber."
$logic1Close = "Energia emprestada cobra juros."
$logic2Title = "Pergunta certa:`nrende ou tapa buraco?"
$logic2Body = "Quando o cafÃ© entra sobre uma base minimamente descansada, ele ajuda.`nQuando entra para encobrir exaustÃ£o crÃ´nica, sÃ³ empurra o problema para depois. DiagnÃ³stico antes do estÃ­mulo."
$logic2Close = "CafÃ© nÃ£o substitui sistema nervoso regulado."
...
Draw-CenterText -Graphics $graphics -Text "A dependÃªncia invisÃ­vel`nda cafeÃ­na" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
Draw-CenterText -Graphics $graphics -Text $coverSupport -Font $bodyFont -Brush $offWhiteBrush -X 152 -Y 566 -Width 776 -Height 144
Draw-Pill -Graphics $graphics -Text "Fundamentos 10" -Font $bodyBoldFont -X 386 -Y 790 -Width 308 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Fundamentos 10  |  Descanso falso vs. descanso real" -Font $eyebrowFont -Brush $eyebrowBrush -X 98 -Y 1060 -Width 884 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 10  |  A DEPENDÃªNCIA INVISÃ­VEL DA CAFEÃ­NA" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
