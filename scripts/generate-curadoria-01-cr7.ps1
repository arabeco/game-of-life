...
$slide1FrameWidth = 214
$slide1FrameHeight = Get-FeatureFrameHeight -ImagePath $cr7CoverPath -FrameWidth $slide1FrameWidth -MinHeight 480 -MaxHeight 620
$slide1FrameBottom = 956
...
Draw-FeatureFrame -Graphics $graphics -X 648 -Y $slide1FrameY -Width $slide1FrameWidth -Height $slide1FrameHeight -ImagePath $cr7CoverPath -Opacity 1.0
...
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} fan page.`n${Eacute} leitura de sistema." -Font $titleMediumFont -Brush $silverBrushSlide -X 100 -Y 980 -Width 620 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Virou porque transformou treino,`nimagem, carreira e ambi${ccedilla}${atilde}o`nem padr${atilde}o di${aacute}rio." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 188) -Width ($slide2PanelWidth - 40) -Height 188
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "F${iacute}sico`n10" -Body "O corpo virou`nm${aacute}quina de`nexecu${ccedilla}${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "A rotina virou`nvantagem`ncompetitiva." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Prop${oacute}sito`n10" -Body "A carreira ganhou`ndire${ccedilla}${atilde}o total`ne ambi${ccedilla}${atilde}o longa." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "F${iacute}sico, Trabalho e Prop${oacute}sito.`nA execu${ccedilla}${atilde}o virou identidade." -Font $bodyFont -Brush $mutedBrush -X 168 -Y 968 -Width 744 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "O n${iacute}vel do CR7 n${atilde}o ${eacute} motiva${ccedilla}${atilde}o.`n${Eacute} sistema de execu${ccedilla}${atilde}o sustentado por anos." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "MESTRIA 01  |  CRISTIANO RONALDO" -Font $eyebrowFont -Brush $eyebrowBrush -X 220 -Y 1060 -Width 640 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 01  |  CRISTIANO RONALDO" -Font ([System.Drawing.Font]::new($headlineFamily, 46, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
