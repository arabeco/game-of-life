param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-04-fome-emocional-vs-fome-fa-sica\slides"
)
...
$coverSupport = "Nem todo desejo por comida Ã© energia.`nÃ€s vezes Ã© fuga."
$logic1Title = "Desejo urgente`nnem sempre Ã© fome."
$logic1Body = "A fome fÃ­sica cresce aos poucos e aceita comida de verdade.`nA emocional costuma pedir aÃ§Ãºcar, pressa e recompensa imediata. Ela aparece mais como anestesia do que como necessidade."
$logic1Close = "Impulso nÃ£o Ã© diagnÃ³stico."
$logic2Title = "Nomear a origem`nevita excesso."
$logic2Body = "Se vocÃª aprende a distinguir cansaÃ§o, estresse e carÃªncia de fome real, para de usar comida como vÃ¡lvula de escape.`nClareza reduz culpa e melhora decisÃ£o."
$logic2Close = "Entender o gatilho Ã© metade do controle."
...
Draw-CenterText -Graphics $graphics -Text "Fome emocional`nvs.`nFome fÃ­sica" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
Draw-CenterText -Graphics $graphics -Text $coverSupport -Font $bodyFont -Brush $offWhiteBrush -X 152 -Y 566 -Width 776 -Height 144
Draw-Pill -Graphics $graphics -Text "Fundamentos 04" -Font $bodyBoldFont -X 386 -Y 790 -Width 308 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Fundamentos 04  |  Descanso falso vs. descanso real" -Font $eyebrowFont -Brush $eyebrowBrush -X 98 -Y 1060 -Width 884 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 04  |  FOME EMOCIONAL VS. FOME FÃ­SICA" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
