...
Draw-CenterText -Graphics $graphics -Text "Sua identidade`nevolui com a`nsua execu${ccedilla}${atilde}o." -Font $heroTitleFont -Brush $goldBrushSlide -X 134 -Y 332 -Width 812 -Height 246
Draw-CenterText -Graphics $graphics -Text "No GLYPH, bordas, skins e prest${iacute}gio visual`ndeixam de ser detalhe. Seu perfil passa a`nmostrar a sua patente." -Font $bodyFont -Brush $silverBrushSlide -X 142 -Y 652 -Width 796 -Height 196
Draw-Pill -Graphics $graphics -Text "Produto 01" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
Draw-Pill -Graphics $graphics -Text "Customiza${ccedilla}${atilde}o" -Font $bodyBoldFont -X 536 -Y 858 -Width 248 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "O GLYPH transforma`nrotina em sistema`nvis${iacute}vel." -Font $titleLargeFont -Brush $goldBrushSlide -X 196 -Y 384 -Width 688 -Height 236
Draw-CenterText -Graphics $graphics -Text "Voc${ecirc} planeja, executa e fecha o ciclo.`nO app organiza a sua evolu${ccedilla}${atilde}o em sinais claros,`nsem virar s${oacute} mais uma lista solta." -Font $bodyFont -Brush $silverBrushSlide -X 176 -Y 676 -Width 728 -Height 236
Draw-CenterText -Graphics $graphics -Text "Menos ru${iacute}do. Mais dire${ccedilla}${atilde}o." -Font $titleSmallFont -Brush $whiteBrush -X 174 -Y 936 -Width 732 -Height 84
...
Draw-CenterText -Graphics $graphics -Text "Produto 01  |  Arsenal e customiza${ccedilla}${atilde}o" -Font $eyebrowFont -Brush $eyebrowBrush -X 210 -Y 1060 -Width 660 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 01  |  CUSTOMIZA${Ccedilla}${Atilde}O DE PERFIL" -Font ([System.Drawing.Font]::new($headlineFamily, 44, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
