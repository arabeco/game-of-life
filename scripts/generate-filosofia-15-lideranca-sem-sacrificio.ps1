param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\filosofia-15-lideranca-sem-sacrificio\\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Liderança sem`nsacrifício`né teatro." -Font $heroTitleFont -Brush $marfimTitleBrush -X 140 -Y 302 -Width 800 -Height 314
Draw-CenterText -Graphics $graphics -Text "Autoridade real cobra preço.`nSem custo pessoal, sobra performance." -Font $bodyFont -Brush $offWhiteBrush -X 158 -Y 670 -Width 764 -Height 132
Draw-Pill -Graphics $graphics -Text "Filosofia 15" -Font $bodyBoldFont -X 404 -Y 824 -Width 272 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Custo" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 122 -Width 912 -Height 168
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 700 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Quem quer conduzir`ntem que carregar." -Font $titleLargeFont -Brush $marfimTitleBrush -X 184 -Y 300 -Width 712 -Height 196
Draw-CenterText -Graphics $graphics -Text "Liderança não é estética de comando.`nÉ suportar peso, atrito e consequência antes dos outros." -Font $bodyFont -Brush $offWhiteBrush -X 180 -Y 540 -Width 720 -Height 248
Draw-CenterText -Graphics $graphics -Text "Sem preço pago, o posto é fantasia." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 838 -Width 728 -Height 120
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Exemplo" -Font $watermarkFont -Brush $goldWashBrush -X 80 -Y 118 -Width 920 -Height 176
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 708 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Influência séria`nnasce de renúncia." -Font $titleLargeFont -Brush $marfimTitleBrush -X 176 -Y 294 -Width 728 -Height 198
Draw-CenterText -Graphics $graphics -Text "As pessoas seguem quem encarna o custo daquilo que exige.`nO resto soa bonito e vazio." -Font $bodyFont -Brush $offWhiteBrush -X 176 -Y 560 -Width 728 -Height 222
Draw-CenterText -Graphics $graphics -Text "Exemplo sem sacrifício não convence." -Font $titleMediumFont -Brush $whiteBrush -X 186 -Y 848 -Width 708 -Height 112
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Filosofia 15  |  Progresso sem registro vira ilusao" -Font $eyebrowFont -Brush $eyebrowBrush -X 132 -Y 1060 -Width 816 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FILOSOFIA 15  |  LIDERANÇA SEM SACRIFÍCIO E TEATRO" -Font ([System.Drawing.Font]::new($headlineFamily, 34, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
