...
export const GENESIS_FOUNDER_REWARD_WINDOW: SeasonRewardWindow = {
  ...
  summary: 'Quem entrou durante a abertura da Temporada 0 carregou a marca da Primeira Era e garantiu os cosméticos de Genesis.',
  rewardLabels: ['Skin O Criador', 'Borda Genesis'],
  rewardItemIds: ['item_skin_season_001', 'item_border_genesis_01'],
  eligibilityDeadline: '2027-01-01',
  eligibilityRule: 'Disponível apenas para contas que entrarem dentro da janela da Temporada 0 - Genesis.',
};

export const AURORA_I_LAUNCH_HIGHLIGHTS: SeasonLaunchHighlights = {
  title: 'Assinatura visual de Aurora I',
  summary: 'Aurora I estreia com sua própria identidade visual. A nova borda, o novo banner e Guardião Aurora registram a abertura da Primeira Era.',
  itemLabels: ['Guardião Aurora', 'Borda Aurora I', 'Banner Aurora I'],
...
export const SEASONS: Record<string, SeasonConfig> = {
  'season-genesis-0': {
    ...
    launchSummary: 'A trilha oficial das Temporadas começa agora. Novas jornadas e cosméticos vão nascer sobre essa base.',
    /**
    ...
    quests: [
      {
        id: 'quest-wanderer',
        title: 'O Andarilho',
        description: 'Caminhe 20km no total para fortalecer pernas e espírito. (Recompensa: 1 Baú Mítico)',
        type: 'individual',
        category: 'physical',
      ...
      },
      {
        id: 'quest-scholar',
        title: 'O Erudito',
        description: 'Leia um livro inteiro ou dedique tempo consistente a leitura. (Recompensa: 1 Baú Mítico)',
        type: 'individual',
  ...
  'season-zenite-1-2026': {
    ...
    name: 'Zenite I',
    description: 'Expansão de meio de ano da Primeira Era. Pressão, clareza e conquista no centro do mapa.',
    backgroundUrl: `${ROOT_IMAGES_URL}/gold.png`,
    startDate: '2027-01-01',
    endDate: '2027-03-20',
    theme: 'zenite',
    celebrationTitle: 'Zenite I concluída',
    celebrationSummary: 'O pico da Primeira Era foi encerrado com a leitura do que subiu e do que resistiu.',
    launchTitle: 'Zenite I',
    launchSummary: 'A nova Temporada entra com sua própria identidade, jornadas e pool de recompensas.',
  ...
  'season-eclipse-1-2026': {
    ...
    endDate: '2027-06-21',
    theme: 'eclipse',
    celebrationTitle: 'Eclipse I concluída',
    ...
    launchSummary: 'A nova Temporada abre um período de contraste, disciplina e consolidacao.',
    quests: EMPTY_SEASON_QUESTS,
  },
  'season-egide-1-2026': {
    id: 'season-egide-1-2026',
    name: 'Egide I',
    description: 'Fechamento defensivo da Primeira Era. Estrutura, blindagem e passagem para a próxima camada.',
    backgroundUrl: `${ROOT_IMAGES_URL}/frost.png`,
    startDate: '2027-06-21',
    endDate: '2027-09-23',
    theme: 'egide',
    celebrationTitle: 'Egide I concluída',
    celebrationSummary: 'O fechamento da Primeira Era foi concluído. O GLYPH entra maduro na Segunda Era.',
    launchTitle: 'Egide I',
    launchSummary: 'A nova Temporada sela o fechamento anual com trilha própria de recompensas.',
    quests: EMPTY_SEASON_QUESTS,
  },
  'season-aurora-2-2027': {
    ...
    name: 'Aurora II',
    description: 'A Segunda Era amanhece com jornadas, recompensas e simbolos próprios. Abertura de jornadas, recompensas e novos simbolos da linha principal.',
    backgroundUrl: `${ROOT_IMAGES_URL}/season-aurora-i-background.webp`,
    startDate: '2027-09-23',
    endDate: '2027-12-21',
    theme: 'aurora',
    celebrationTitle: 'Aurora II concluída',
    celebrationSummary: 'A Temporada que abre a Segunda Era fecha sua trilha.',
    launchTitle: 'Aurora II',
    launchSummary: 'A nova Temporada entra em campo com cosméticos, jornadas e recompensas próprias.',
    launchHighlights: AURORA_I_LAUNCH_HIGHLIGHTS,
    launchRewardItemIds: ['insignia_season_aurora_1'],
    launchRewardToast: 'Insígnia Aurora II integrada ao inventário.',
    quests: [
      {
        ...
        type: 'individual',
        category: 'physical',
        season_id: 'season-aurora-2-2027',
        actionTemplate: {
          name: 'Travessia Aurora (2km)',
          description: 'Percorrer 2 km com constância, respiracao firme e presença.',
          duration: 18,
          icon: '🌄',
          repetitions: 12,
          difficulty: 2,
      ...
      },
      {
        ...
        actionTemplate: {
          ...
          description: 'Ler com foco total por 30 minutos e registrar a sessão.',
          duration: 30,
          icon: '📚',
          repetitions: 12,
          difficulty: 2,
      ...
      },
      {
        ...
        season_id: 'season-aurora-2-2027',
        actionTemplate: {
          name: 'Meditação da Bruma',
          description: 'Sessão curta de meditação para estabilizar mente e respiracao.',
          duration: 12,
          icon: '🧘',
          repetitions: 15,
          isMilestone: true,
      ...
      },
      {
        ...
        title: 'A Vigília da Aurora',
        description: 'Como grupo, completem 30 rondas da Aurora para manter a temporada desperta. Recompensa: 1 Baú Épico por participante.',
        type: 'clan',
        category: 'social',
        season_id: 'season-aurora-2-2027',
        actionTemplate: {
  ...
  'season-zenite-2-2027': {
    ...
    name: 'Zenite II',
    description: 'Pressão central da Segunda Era. Ritmo alto, leituras mais duras e recompensa mais rara.',
    backgroundUrl: `${ROOT_IMAGES_URL}/gold.png`,
  ...
  'season-zenite-3-2028': {
    ...
    name: 'Zenite III',
    description: 'O centro da Terceira Era pede domínio fino, consistência e alta entrega.',
    backgroundUrl: `${ROOT_IMAGES_URL}/gold.png`,
  ...
  'season-egide-3-2028': {
    ...
    name: 'Egide III',
    description: 'O fechamento da Terceira Era protege o que foi conquistado e prepara a próxima camada.',
    backgroundUrl: `${ROOT_IMAGES_URL}/frost.png`,
...
export const GM_SEASON_MISSIONS: SeasonMission[] = [
   ...
   */
  {
    ...
    description: 'Conclua as 3 jornadas da Temporada Zero para selar a Primeira Era. Recompensa: Insígnia Genesis e o Tema Genesis.',
  ...
  },
  {
    ...
    description: 'Conclua as 3 jornadas da Aurora I para selar a abertura oficial da Primeira Era. Recompensa: Insígnia Aurora I e o Tema Aurora I.',
    goal_type: 'quests_claimed',
    goal_value: 3,
    reward_type: 'item_id',
...
export const GM_SEASON_QUESTS: SeasonQuest[] = [
  {
    ...
    actionTemplate: {
      name: 'Andar 1km',
      description: 'Execução unitaria da quest do Andarilho.',
      icon: '🚶',
      duration: 15,
      repetitions: 20,
    },
