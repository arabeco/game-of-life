param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\mestria-12-miyamoto-musashi\\slides"
)
...
$round6MestriaRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round12\\mestria"
$round6FallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round12"
...
Draw-CenterText -Graphics $graphics -Text "Miyamoto Musashi" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
...
Draw-CenterText -Graphics $graphics -Text "Como o Glyph`nleria Miyamoto`nMusashi?" -Font $titleHugeFont -Brush $goldBrushSlide -X 94 -Y 392 -Width 592 -Height 448
Draw-Pill -Graphics $graphics -Text "Nível de maestria 93" -Font $bodyBoldFont -X 186 -Y 860 -Width 392 -Height 56
Draw-CenterText -Graphics $graphics -Text "Não era só combate.`nEra estratégia, silêncio e precisão." -Font $titleMediumFont -Brush $silverBrushSlide -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Miyamoto Musashi" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 90 -Y 128 -Width 900 -Height 120
$slide2PanelX = 118
$slide2PanelY = 334
...
Draw-CenterText -Graphics $graphics -Text "Musashi não lutava`nsó por vitória." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Transformou disciplina, observação e frieza`nem vantagem antes do confronto começar." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Estratégia virou arma.`nClareza virou domínio." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-CenterText -Graphics $graphics -Text "Miyamoto Musashi" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
Draw-CenterText -Graphics $graphics -Text "Estratégia,`nofício e aço." -Font $titleLargeFont -Brush $goldBrushSlide -X 120 -Y 232 -Width 626 -Height 176
Draw-ClippedImageBox -Graphics $graphics -ImagePath $cr7Slide3Path -X 738 -Y 184 -Width 214 -Height 254 -Opacity 0.98 -AlignBottom
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Espaço mental`n10" -Body "Calma para ler`nritmo, vazio e`nmovimento sem`nentrar em ruído." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Treino brutal até`no fundamento virar`nresposta imediata." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Físico`n10" -Body "Corpo afiado para`nsustentar técnica,`npresença e impacto." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "Espaço Mental, Trabalho e Físico.`nMusashi fazia do controle uma arma." -Font $bodyFont -Brush $mutedBrush -X 150 -Y 964 -Width 780 -Height 104
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "93" -Font $monoTitleFont -Brush $whiteBrush -X 350 -Y 174 -Width 380 -Height 180
$labels = @(
    "Consci${ecirc}ncia",
...
$values = @(10,10,9,10,10,9,7,10,8,10)
...
Draw-CenterText -Graphics $graphics -Text "Miyamoto Musashi operava em disciplina,`nleitura, combate e dire${ccedilla}${atilde}o absoluta." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mestria 10  |  Miyamoto Musashi" -Font $eyebrowFont -Brush $eyebrowBrush -X 148 -Y 1060 -Width 784 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 12  |  MIYAMOTO MUSASHI" -Font ([System.Drawing.Font]::new($headlineFamily, 40, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
