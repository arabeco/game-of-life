param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-09-o-filtro-do-controle\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-09-o-filtro-do-controle\assets"
...
$quoteText = "Não é o que acontece,`nmas como você reage`nque importa."
$supportCore = "O filósofo que separou o que fere do que você entrega a isso."
$analysis1Title = "O que Epicteto fez?"
...
$analysis2Body = "Porque sofrer costuma empurrar o ser humano para o impulso.`nEpicteto fez o contrário: construiu uma filosofia inteira em torno de disciplina interior."
...
Draw-Pill -Graphics $graphics -Text "Legado 09  |  Epicteto" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "O Filtro do`nControle" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 09  |  Epicteto" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 09  |  O FILTRO DO CONTROLE" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
