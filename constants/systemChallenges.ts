...
export const SYSTEM_CHALLENGES: SystemChallenge[] = [
  ...
  // trabalho em dois lugares, com numeros diferentes.
  {
    ...
    actionTemplate: {
      name: 'Tutorial de Iniciação',
      description: 'Concluir a sequência inicial.',
      icon: '\u{1F393}',
      duration: 0,
      repetitions: 1,
      isMilestone: true,
  ...
  },
  {
    ...
    actionTemplate: {
      ...
      description: 'Ter um ciclo ativo ou um ciclo já fechado.',
      icon: '\u{1F504}',
      duration: 0,
      repetitions: 1,
      isMilestone: true,
  ...
  },
  {
    ...
    description: 'Feche um ciclo inteiro e gere o primeiro relatório.',
    type: 'individual',
    category: 'spiritual',
    actionTemplate: {
      name: 'Primeiro Relatório de Ciclo',
      description: 'Gerar o primeiro relatório de ciclo completo.',
      icon: '\u{1F4DC}',
      duration: 0,
      repetitions: 1,
      isMilestone: true,
  ...
  },
  {
    ...
    source: 'system',
    title: 'Concluir a primeira ação',
    description: 'Conclua uma ação de verdade.',
    type: 'individual',
    category: 'physical',
    actionTemplate: {
      name: 'Primeira Ação Concluída',
      description: 'Ter ao menos uma tarefa concluída.',
      icon: '✅',
      duration: 0,
      repetitions: 1,
      isMilestone: true,
  ...
  },
  {
    ...
    description: 'Coloque uma ação no planner.',
    type: 'individual',
    category: 'intellectual',
    actionTemplate: {
  ...
  },
  {
    ...
    actionTemplate: {
      ...
      description: 'Ter uma peça equipada no perfil.',
      icon: '👑',
      duration: 0,
      repetitions: 1,
      isMilestone: true,
  ...
  },
  {
    ...
    source: 'system',
    title: 'Escolher a primeira missão individual',
    description: 'Peça uma missão ao Oráculo e escolha a sua.',
    type: 'individual',
    category: 'spiritual',
    actionTemplate: {
      name: 'Primeira Missão Individual',
      description: 'Ter escolhido uma missão individual.',
      icon: '🔮',
      duration: 0,
      repetitions: 1,
      isMilestone: true,
  ...
  },
  {
    ...
    source: 'system',
    title: 'Entrar num clã',
    description: 'Junte-se a um clã.',
    type: 'individual',
    category: 'social',
    actionTemplate: {
      name: 'Primeiro Clã',
      description: 'Fazer parte de um clã.',
      icon: '🛡️',
      duration: 0,
      repetitions: 1,
      isMilestone: true,
