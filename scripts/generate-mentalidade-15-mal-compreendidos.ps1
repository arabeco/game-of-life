param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\mentalidade-15-mal-compreendidos\\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Os grandes suportam`nser mal compreendidos`npor mais tempo." -Font $heroTitleFont -Brush $goldBrushSlide -X 138 -Y 286 -Width 804 -Height 388
Draw-CenterText -Graphics $graphics -Text "Visão longa quase sempre parece estranha no começo." -Font $bodyFont -Brush $silverBrushSlide -X 170 -Y 720 -Width 740 -Height 116
Draw-Pill -Graphics $graphics -Text "Mentalidade 15" -Font $bodyBoldFont -X 382 -Y 836 -Width 316 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Aprovação" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 122 -Y 236 -Width 836 -Height 724
Draw-CenterText -Graphics $graphics -Text "Quem precisa ser`nentendido cedo`ndemais se vende." -Font $titleLargeFont -Brush $goldBrushSlide -X 162 -Y 278 -Width 756 -Height 196
Draw-CenterText -Graphics $graphics -Text "Ansiedade por validação empurra decisões curtas.`nÉ assim que muita grandeza morre ainda pequena." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Pressa por aceitação encurta destino." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Firmeza" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 122 -Y 236 -Width 836 -Height 730
Draw-CenterText -Graphics $graphics -Text "A elite aguenta o`nruído sem largar`na direção." -Font $titleLargeFont -Brush $goldBrushSlide -X 154 -Y 256 -Width 772 -Height 246
Draw-CenterText -Graphics $graphics -Text "Nem toda visão consegue ser explicada no primeiro minuto.`nOs melhores aceitam isso e seguem construindo." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Nem toda verdade nasce popular." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mentalidade 15  |  Gente world class pensa em decadas, nao em humores" -Font $eyebrowFont -Brush $eyebrowBrush -X 58 -Y 1060 -Width 964 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MENTALIDADE 15  |  OS GRANDES SUPORTAM SER MAL COMPREENDIDOS POR MAIS TEMPO" -Font ([System.Drawing.Font]::new($headlineFamily, 24, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
