param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-13-a-defesa-da-raza-o\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-13-a-defesa-da-raza-o\assets"
...
$quoteText = "Reserve seu direito de pensar.`nAtÃ© pensar errado Ã© melhor`ndo que nÃ£o pensar."
$supportCore = "A pensadora que defendeu conhecimento e lucidez em um tempo hostil Ã  razÃ£o."
$analysis1Title = "O que HipÃ¡cia de Alexandria fez?"
$analysis1 = "HipÃ¡cia foi matemÃ¡tica, astrÃ´noma e filÃ³sofa em Alexandria, liderando ensino e produÃ§Ã£o intelectual em uma era de conflito polÃ­tico e religioso.`nSua presenÃ§a pÃºblica como mulher de pensamento jÃ¡ era, por si, um ato raro."
$analysis1Close = "Ela ocupou o centro da inteligÃªncia onde quase nÃ£o havia espaÃ§o para isso."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque defender razÃ£o em tempos inflamados custa caro.`nHipÃ¡cia virou sÃ­mbolo de lucidez ameaÃ§ada justamente porque se recusou a abandonar pensamento rigoroso diante da pressÃ£o do tempo."
$analysis2Close = "Ela lembrou que pensar com firmeza tambÃ©m Ã© coragem."
...
Draw-Pill -Graphics $graphics -Text "Legado 13  |  HipÃ¡cia de Alexandria" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "A Defesa`nda RazÃ£o" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 13  |  HipÃ¡cia de Alexandria" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 13  |  A DEFESA DA RAZÃ£O" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
