param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-04-o-poder-da-observaa-a-o-paciente\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-04-o-poder-da-observaa-a-o-paciente\assets"
...
$quoteText = "O que vocÃª faz`nfaz diferenÃ§a.`nE vocÃª decide`nque diferenÃ§a quer fazer."
$supportCore = "A pesquisadora que trocou pressa por dÃ©cadas de observaÃ§Ã£o atÃ© mudar a biologia."
$analysis1Title = "O que Viktor Frankl fez?"
$analysis1 = "Jane Goodall passou dÃ©cadas observando chimpanzÃ©s em campo, com paciÃªncia e presenÃ§a rarÃ­ssimas.`nO que ela viu derrubou certezas da ciÃªncia sobre ferramenta, emoÃ§Ã£o, vÃ­nculo e o lugar do humano na natureza."
$analysis1Close = "Ela provou que profundidade exige permanÃªncia."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque quase todo mundo quer resultado rÃ¡pido. Goodall apostou na lentidÃ£o, na observaÃ§Ã£o contÃ­nua e no acÃºmulo paciente atÃ© mudar uma Ã¡rea inteira."
...
Draw-Pill -Graphics $graphics -Text "Legado 04  |  Jane Goodall" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "O Poder da`nObservaÃ§Ã£o`nPaciente" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 04  |  Jane Goodall" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 04  |  O PODER DA OBSERVAÃ§Ã£O PACIENTE" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
