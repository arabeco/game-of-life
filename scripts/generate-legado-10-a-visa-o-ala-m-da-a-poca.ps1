param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-10-a-visa-o-ala-m-da-a-poca\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-10-a-visa-o-ala-m-da-a-poca\assets"
...
$quoteText = "A imaginaÃ§Ã£o`nÃ© a faculdade`nda descoberta."
$supportCore = "A mente que imaginou programaÃ§Ã£o antes de existir computador."
$analysis1Title = "O que Viktor Frankl fez?"
$analysis1 = "Ada Lovelace escreveu, no sÃ©culo XIX, a visÃ£o de uma mÃ¡quina capaz de manipular sÃ­mbolos e seguir instruÃ§Ãµes gerais.`nAntes do computador existir fisicamente, ela jÃ¡ enxergava a lÃ³gica da programaÃ§Ã£o."
$analysis1Close = "Ela enxergou uma mÃ¡quina antes da mÃ¡quina."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque imaginar a estrutura de algo antes de sua existÃªncia material exige visÃ£o rara.`nAda nÃ£o previu sÃ³ uma mÃ¡quina: previu uma linguagem."
...
Draw-CenterText -Graphics $graphics -Text "A VisÃ£o AlÃ©m`nda Ã‰poca" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 10  |  Ada Lovelace" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 10  |  A VISÃ£O ALÃ©M DA Ã‰POCA" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
