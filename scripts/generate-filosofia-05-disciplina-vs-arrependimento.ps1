param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\filosofia-05-disciplina-vs-arrependimento\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Voc${ecirc} sempre vai`nter que escolher`nqual dor carrega." -Font $heroTitleFont -Brush $marfimTitleBrush -X 140 -Y 326 -Width 800 -Height 270
Draw-CenterText -Graphics $graphics -Text "A dor da disciplina pesa on${ccedilla}as.`nA do arrependimento pesa toneladas." -Font $bodyFont -Brush $offWhiteBrush -X 158 -Y 654 -Width 764 -Height 132
Draw-Pill -Graphics $graphics -Text "Filosofia 05" -Font $bodyBoldFont -X 404 -Y 824 -Width 272 -Height 54
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgMarfim -Width $width -Height $height -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Disciplina" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 122 -Width 912 -Height 168
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 700 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "A dor da disciplina`ncobra cedo." -Font $titleLargeFont -Brush $marfimTitleBrush -X 184 -Y 300 -Width 712 -Height 196
Draw-CenterText -Graphics $graphics -Text "Ela pede esfor${ccedilla}o, repeti${ccedilla}${atilde}o, ren${uacute}ncia`ne fric${ccedilla}${atilde}o agora, enquanto ainda h${aacute} tempo." -Font $bodyFont -Brush $offWhiteBrush -X 184 -Y 566 -Width 712 -Height 206
Draw-CenterText -Graphics $graphics -Text "Pesa on${ccedilla}as." -Font $titleMediumFont -Brush $whiteBrush -X 188 -Y 844 -Width 704 -Height 108
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
$slide2 = Join-Path $OutputDir "slide-02-disciplina.png"
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgMarfim -Width $width -Height $height -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Arrependimento" -Font $watermarkFont -Brush $goldWashBrush -X 80 -Y 118 -Width 920 -Height 176
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 708 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "A dor do arrependimento`ncobra tarde." -Font $titleLargeFont -Brush $marfimTitleBrush -X 176 -Y 294 -Width 728 -Height 198
Draw-CenterText -Graphics $graphics -Text "Ela chega quando o tempo passou`ne o potencial virou aus${ecirc}ncia, peso e lembran${ccedilla}a." -Font $bodyFont -Brush $offWhiteBrush -X 184 -Y 578 -Width 712 -Height 188
Draw-CenterText -Graphics $graphics -Text "Pesa toneladas." -Font $titleMediumFont -Brush $whiteBrush -X 186 -Y 846 -Width 708 -Height 112
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
$slide3 = Join-Path $OutputDir "slide-03-arrependimento.png"
...
Draw-CenterText -Graphics $graphics -Text "Filosofia 05  |  Disciplina vs arrependimento" -Font $eyebrowFont -Brush $eyebrowBrush -X 152 -Y 1060 -Width 776 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FILOSOFIA 05  |  DISCIPLINA VS ARREPENDIMENTO" -Font ([System.Drawing.Font]::new($headlineFamily, 40, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
