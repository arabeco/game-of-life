...
const SEPHIROT = [
  ...
  { id: "abundancia", label: "FINAN├çAS", row: 5, col: 3 },
...
const LAYOUT_CONFIG = {
  ...
  espiritualidade: [
    ...
    { title: "SANTU├üRIO" },
    { slot: "entidade1", type: 3, span: 2, label: "L├¡der" },
    { slot: "entidade2", type: 3, span: 2, label: "Protetor" },
    { slot: "entidade3", type: 3, span: 2, label: "Guardi├úo" },
  ],
  mente: [
  ...
  layout.forEach((config, index) => {
    ...
    switch (config.type) {
      case 1: {
        ...
        valueDisplay.textContent = slotData.value || "ÔÇö";
        ...
        input.addEventListener("change", (e) => {
          ...
          valueDisplay.textContent = e.target.value || "ÔÇö";
        });
