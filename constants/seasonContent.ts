...
export const SEASONS: Record<string, SeasonConfig> = {
  ...
  'season-aurora-2-2027': {
    ...
    name: 'Aurora II',
    description: 'A Segunda Era amanhece com jornadas, recompensas e simbolos proprios. Abertura de jornadas, recompensas e novos simbolos da linha principal.',
    backgroundUrl: `${ROOT_IMAGES_URL}/season-aurora-i-background.webp`,
    startDate: '2027-09-23',
    endDate: '2027-12-21',
    theme: 'aurora',
    celebrationTitle: 'Aurora II concluida',
    ...
    launchRewardToast: 'Insignia Aurora II integrada ao inventario.',
    quests: [
      {
