export const GOLD_PACK_CATALOG = [
    { id: 'pack_gold_1', name: 'Pepita', priceBrl: 5, goldBase: 50, bonusGold: 0, totalGold: 50, icon: '🪙' },
    { id: 'pack_gold_2', name: 'Barra Pequena', priceBrl: 10, goldBase: 100, bonusGold: 10, totalGold: 110, icon: '🧈' },
    { id: 'pack_gold_3', name: 'Barra Grande', priceBrl: 20, goldBase: 200, bonusGold: 30, totalGold: 230, icon: '🧱' },
    { id: 'pack_gold_4', name: 'Cofre', priceBrl: 50, goldBase: 500, bonusGold: 100, totalGold: 600, icon: '🏦' },
    { id: 'pack_gold_5', name: 'Tesouro', priceBrl: 100, goldBase: 1000, bonusGold: 300, totalGold: 1300, icon: '💎' },
] as const;
...
export const ACTIVE_GOLD_STORE_ITEMS = [
    ...
    { id: 'item_skin_2_003', name: 'Academico', category: 'skin', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_2_003 },
    { id: 'item_orb_2_003', name: 'Orbe Tempestade', category: 'orb', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_orb_2_003 },
    { id: 'item_skin_3_001', name: 'Nomade', category: 'skin', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_001 },
    { id: 'item_banner_imparavel', name: 'Imparavel', category: 'banner', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_imparavel },
    { id: 'item_skin_3_002', name: 'Alquimista', category: 'skin', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_002 },
    { id: 'item_skin_3_003', name: 'Hibrido', category: 'skin', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_003 },
    { id: 'item_orb_3_001', name: 'Orbe de Ouro', category: 'orb', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_orb_3_001 },
    { id: 'item_banner_t3_mistico', name: 'Mistico', category: 'banner', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_t3_mistico },
    ...
    { id: 'item_banner_t4_oraculo', name: 'Oraculo', category: 'banner', tier: 4, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_t4_oraculo },
...
export const GOLD_CODEX_CATALOG = [
    ...
    { id: 'reset_dopaminergico', name: 'Reset Dopaminergico', priceGold: 350, source: 'sql' },
    { id: 'foco_blindado', name: 'Foco Blindado', priceGold: 500, source: 'sql' },
    { id: 'logistica_de_vanguarda', name: 'Logistica de Vanguarda', priceGold: 350, source: 'sql' },
...
export const GOLD_CATALOG_NOTES = [
    ...
    'Nao existe mais compra separada de slot de criacao. A compra ativa ja libera o uso.',
    'Nao existe mais compra separada de capacidade social. O catalogo ativo nao lista slots.',
    'Empreendedor, Fundador e Fenix Dourada ficaram arquivados fora do catalogo ativo.',
] as const;
