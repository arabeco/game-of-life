...
Draw-CenterText -Graphics $graphics -Text "Alta performance come${ccedilla}a no que voc${ecirc}`nescolhe n${atilde}o perseguir." -Font $bodyFont -Brush $offWhiteBrush -X 214 -Y 694 -Width 652 -Height 84
...
Draw-CenterText -Graphics $graphics -Text "Mas esfor${ccedilla}o espalhado vira`nru${iacute}do, troca de contexto`ne ansiedade." -Font $bodyFont -Brush $offWhiteBrush -X 182 -Y 520 -Width 716 -Height 152
...
Draw-CenterText -Graphics $graphics -Text "Escolhe poucos alvos, repete`nfundamentos e sustenta press${atilde}o`nna mesma frente at${eacute} o`nresultado aparecer." -Font $bodyFont -Brush $offWhiteBrush -X 182 -Y 528 -Width 716 -Height 220
