param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\mestria-14-pele\\slides"
)
...
$round6MestriaRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round14\\mestria"
$round6FallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round14"
...
Draw-CenterText -Graphics $graphics -Text "Pelé" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
...
Draw-CenterText -Graphics $graphics -Text "Como o Glyph`nleria Pelé?" -Font $titleHugeFont -Brush $goldBrushSlide -X 94 -Y 392 -Width 592 -Height 448
Draw-Pill -Graphics $graphics -Text "Nível de maestria 90" -Font $bodyBoldFont -X 186 -Y 860 -Width 392 -Height 56
Draw-CenterText -Graphics $graphics -Text "Não era só carisma.`nEra execução, visão e legado vivo." -Font $titleMediumFont -Brush $silverBrushSlide -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Pelé" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 90 -Y 128 -Width 900 -Height 120
$slide2PanelX = 118
$slide2PanelY = 334
...
Draw-CenterText -Graphics $graphics -Text "Pelé não virou`nsímbolo por acaso." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Transformou talento, leitura e consistência`nem influência que atravessou gerações." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Brilho virou padrão.`nImpacto virou história." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-CenterText -Graphics $graphics -Text "Pelé" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
Draw-CenterText -Graphics $graphics -Text "Execução,`ncarisma e visão." -Font $titleLargeFont -Brush $goldBrushSlide -X 120 -Y 232 -Width 626 -Height 176
Draw-ClippedImageBox -Graphics $graphics -ImagePath $cr7Slide3Path -X 738 -Y 184 -Width 214 -Height 254 -Opacity 0.98 -AlignBottom
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Físico`n10" -Body "Corpo pronto para`nimpor ritmo,`nreação e presença`nem alto nível." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Propósito`n10" -Body "Consciência de`npapel, missão e`nimpacto muito além`ndo campo." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Conexões`n10" -Body "Ligação rara com`no público sem`nperder centro nem`nidentidade." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "Físico, Propósito e Conexões.`nPelé fez da excelência uma linguagem global." -Font $bodyFont -Brush $mutedBrush -X 150 -Y 964 -Width 780 -Height 104
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Pel${eacute} operava em leitura,`npresen${ccedilla}a, inven${ccedilla}${atilde}o e decis${atilde}o." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mestria 10  |  Pelé" -Font $eyebrowFont -Brush $eyebrowBrush -X 148 -Y 1060 -Width 784 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 14  |  PELÉ" -Font ([System.Drawing.Font]::new($headlineFamily, 40, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
