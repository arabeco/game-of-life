...
export const ORACLE_VOICE_EXAMPLES: Record<OracleHostOperationalState, Record<OracleHostSurface, string[]>> = {
  sem_direcao: {
    push: ["Seu dia ainda nao tem uma conclusao. Escolha uma acao pequena.", "Vamos dar trilho para hoje: uma frente, um passo.", "Antes de organizar tudo, escolha a primeira coisa que cabe."],
    ...
    card: ["PRIORIDADE: dar trilho ao dia.\nRISCO: continuar navegando sem executar.\nAJA: escolha uma area e crie uma acao curta.", "PRIORIDADE: primeiro movimento.\nRISCO: tentar configurar tudo antes de comecar.\nAJA: crie uma arena simples e uma acao de hoje."],
  },
  disperso: {
    push: ["Tem coisa demais aberta. Fecha uma acao curta antes de mexer no resto.", "Mapa grande demais. Uma acao agora.", "Nao abre outra frente ainda. Conclui uma acao pequena."],
    balao: ["O mapa esta grande demais agora. Uma arena e uma acao de cada vez.", "Voce nao precisa decidir tudo. Escolhe a menor acao que tira o dia do zero."],
  ...
  atrasado: {
    push: ["O dia correu na frente. Uma acao pequena ainda salva tracao.", "Nao tenta compensar tudo. Conclui algo que ainda cabe.", "Atraso pede corte, nao culpa. Escolhe a menor entrega."],
    balao: ["O tempo correu na frente. Nao reorganiza tudo: conclui uma acao pequena agora.", "Se o dia te atropelou, a resposta nao e drama. E uma acao que ainda cabe."],
    chat: ["O atraso aqui nao pede drama. Se uma acao pequena sair hoje, o dia volta a ter tracao.", "O plano ainda faz sentido ou o dia te atropelou? Se atropelou, a gente reduz para uma entrega que ainda caiba."],
  ...
  retomando: {
    push: ["Voce voltou. Uma conclusao pequena reabre o fio."],
    balao: ["Nao tenta pagar os dias perdidos agora. Conclui uma acao possivel e volta para o jogo."],
    chat: ["Retorno bom nao e compensar tudo. E fazer uma acao real hoje para o sistema voltar a ter pulso."],
    card: ["PRIORIDADE: retomar sem compensacao.\nRISCO: tentar resolver o atraso inteiro.\nAJA: conclua uma acao possivel hoje."],
  },
  proximo_compromisso: {
  ...
  pronto_para_fechar: {
    push: ["Seu dia ja tem material. Fecha antes que vire ruido.", "Ja tem registro para guardar. Fecha o dia com calma.", "Nao deixa o dia aberto na cabeca."],
    ...
    chat: ["O dia ja tem materia suficiente para fechamento. Revisar agora deixa o proximo movimento mais limpo.", "Pergunta curta: o que voce fez hoje que merece ficar registrado? Vamos guardar isso sem transformar em relatorio pesado."],
  ...
  streak_mantida: {
    push: ["Sequencia mantida. Uma acao concluida fez o dia contar.", "Boa. Hoje ja contou.", "A sequencia continua viva."],
    balao: ["Sequencia mantida: uma acao real ja contou hoje.", "Boa. Nao precisou ser perfeito; precisou acontecer."],
    chat: ["A sequencia nao vive de login, vive de acao concluida. Hoje ja contou.", "Boa. Agora o dia saiu do zero. Se for continuar, que seja sem abrir frente desnecessaria."],
  ...
  streak_quebrada: {
    ...
    balao: ["Caiu, voltou. Sem drama: conclui uma acao e recomeca o fio."],
  ...
  primeira_acao_do_dia: {
    ...
    balao: ["Primeira acao do dia concluida. A sequencia continua viva."],
