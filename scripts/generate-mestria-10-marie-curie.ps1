...
Draw-Pill -Graphics $graphics -Text "N${Iacute}vel de maestria 82" -Font $bodyBoldFont -X 186 -Y 860 -Width 392 -Height 56
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o era s${oacute} genialidade.`nEra rigor, sacrif${iacute}cio e foco." -Font $titleMediumFont -Brush $silverBrushSlide -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Curie n${Atilde}o descobriu`ns${oacute} ciencia." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Transformou estudo, risco e resist${ecirc}ncia`nem descoberta real e legado`nimposs${iacute}vel de apagar." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Metodo virou for${ccedilla}a.`nSacrificio virou fronteira." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Espa${ccedilla}o mental`n10" -Body "Clareza fria para`ncontinuar pensando`nonde quase todos`nparariam." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Metodo, repeticao`ne rigor at${eacute}`na descoberta virar fato." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Prop${oacute}sito`n10" -Body "Ci${ecirc}ncia como miss${atilde}o,`nnao como vaidade`nou ornamento." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
...
Draw-CenterText -Graphics $graphics -Text "82" -Font $monoTitleFont -Brush $whiteBrush -X 350 -Y 174 -Width 380 -Height 180
$labels = @(
    "Consci${ecirc}ncia",
...
$values = @(10,10,8,10,10,6,4,10,8,6)
...
Draw-CenterText -Graphics $graphics -Text "Marie Curie operava em foco, m${eacute}todo,`ndescoberta e sacrif${iacute}cio extremo." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
