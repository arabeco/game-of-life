...
const DetailModalShell: React.FC<{
    ...
    <Portal>
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-black/90 p-4 backdrop-blur-md animate-fade-in" onClick={onClose}>
            <div className="relative flex max-h-[80vh] w-full max-w-sm flex-col overflow-hidden rounded-[30px] border border-[var(--skin-accent-color)]/25 bg-[linear-gradient(180deg,rgba(16,16,16,0.98),rgba(4,4,4,0.98))] shadow-[0_0_50px_rgba(0,0,0,0.8)]" onClick={(event) => event.stopPropagation()}>
                <div className="flex justify-end p-4 pb-0">
                    <button onClick={onClose} className="rounded-full border border-white/10 bg-black/40 px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] text-white/80 transition-colors hover:bg-black/60">
                        OK
                    </button>
                </div>
                <div className="custom-scrollbar flex-1 overflow-y-auto px-5 pb-5 pt-4">
                    <div className="space-y-4 text-center">
                        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-[var(--skin-accent-color)]/35 bg-white/5 text-3xl shadow-[0_0_20px_var(--sephirot-glow-color)]">
                            {icon || 'o'}
                        </div>
                        ...
                        <div className="space-y-2 rounded-[20px] border border-white/8 bg-white/[0.03] p-4 text-left">
        ...
        <Portal>
            <div className="fixed inset-0 z-[70] flex items-center justify-center bg-black/80 p-4 backdrop-blur-md animate-fade-in" onClick={onClose}>
                <div className="w-full max-w-[520px]" onClick={(event) => event.stopPropagation()}>
                    <div className="dossier-bg relative flex max-h-[92vh] flex-col overflow-hidden rounded-[28px] border border-[color:var(--skin-accent-color)] shadow-2xl shadow-black/60">
                        ...
                        <div className="custom-scrollbar relative z-10 flex-1 space-y-5 overflow-y-auto px-4 pb-4 pt-4">
                            <div className="space-y-2 rounded-[22px] border border-white/8 bg-black/24 p-4">
                            ...
                            {missionItems.length === 0 && questItems.length === 0 && (
                                <div className="flex flex-col items-center justify-center gap-3 rounded-[22px] border border-white/8 bg-black/24 py-10 text-center text-white/50">
