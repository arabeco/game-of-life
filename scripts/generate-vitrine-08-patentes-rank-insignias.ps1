...
Draw-CenterText -Graphics $graphics -Text "No GLYPH, progresso social n${atilde}o fica abstrato.`nEle sobe em 10 patentes reais." -Font $bodyFont -Brush $offWhiteBrush -X 142 -Y 642 -Width 796 -Height 196
...
Draw-CenterText -Graphics $graphics -Text "S${atilde}o 10 patentes vis${iacute}veis,`nde Vagante a Soberano.`nA execu${ccedilla}${atilde}o sobe de patente e ganha peso social." -Font $bodyFont -Brush $offWhiteBrush -X 176 -Y 676 -Width 728 -Height 236
