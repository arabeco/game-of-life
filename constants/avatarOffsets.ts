...
export const AVATAR_OFFSETS: Record<string, AvatarOffset> = {
    ...
    'CABELO_T1_RABO_DE_CAVALO_ama.png': { x: 3, y: 3 },
    'CABELO_T1_RABO_DE_CAVALO_bran.png': { x: 1, y: 1 },
    'CABELO_T1_RABO_DE_CAVALO_cast.png': { x: 2 },
    'CABELO_T2_COQUE_SOLTO_ama.png': { x: 2, y: 1 },
    'CABELO_T2_COQUE_SOLTO_bran.png': { x: 1 },
    'CABELO_T2_COQUE_SOLTO_cast.png': { x: 1 },
    'CABELO_T2_COQUE_SOLTO_pre.png': { x: 1 },
    'CABELO_T2_TEXTURED_CROP_ama.png': { x: -3, y: 15 },
    ...
    'CABELO_T3_DREADS_ama.png': { x: -3, y: 13 },
    ...
    'CABELO_T3_UNDERCUT_ama.png': { x: -1, y: -56, scale: 0.7 },
    'CABELO_T3_UNDERCUT_bran.png': { x: -2, y: -56, scale: 0.7 },
    'CABELO_T3_UNDERCUT_cast.png': { x: -1, y: -55, scale: 0.7 },
    'CABELO_T3_UNDERCUT_pre.png': { x: -1, y: -54, scale: 0.7 },
    ...
    'CABELO_T4_PRINCESA_ama.png': { x: -2, y: 16 },
    'CABELO_T4_PRINCESA_bran.png': { x: -2, y: 11 },
    'CABELO_T4_PRINCESA_cast.png': { x: -1, y: 17 },
    'CABELO_T4_PRINCESA_preto.png': { y: 11 },
    'CABELO_T4_TRANCA_LATERAL_ama.png': { y: 2 },
    'CABELO_T4_TRANCA_LATERAL_bran.png': { y: 4 },
    'CABELO_T4_TRANCA_LATERAL_cast.png': { y: 4 },
    'CABELO_T4_TRANCA_LATERAL_rosa.png': { y: 3 },
    ...
    'SKIN_T1_CHUVA.png': { x: -2, y: -3, cobre: ['pes', 'pernas'] },
    'SKIN_T1_CORRIDA.png': { cobre: ['pes'] },
    'SKIN_T1_ESCUDEIRO.png': { x: -2, y: -4, scale: 1.04, cobre: ['pernas', 'pes'] },
    'SKIN_T1_GYM_RAT.png': { x: 1, cobre: ['pes'], recortes: [[194, 232, 48, 71]], porCorpo: { 'body_fem': { x: -4, y: 7, scale: 1.04 } } },
    'SKIN_T1_NAUFRAGO.png': { cobre: ['pernas'], x: -3, scale: 1.04 },
    'SKIN_T1_PIJAMA.png': { cobre: ['pernas', 'pes'] },
    'SKIN_T1_STREET.png': { x: 2, y: -6, cobre: ['pernas', 'pes'], recortes: [[192, 212, 29, 97]], cabelo: 'porBaixo' },
    'SKIN_T1_VERAO.png': { cobre: ['pes'] },
    'SKIN_T2_ACADEMICO.png': { x: 2, y: 2, scale: 1.02, cobre: ['pernas', 'pes'], recortes: [[168, 165, 159, 74]], porCorpo: { 'body_fem': { x: 1, y: 4 } } },
    'SKIN_T2_BARAO.png': { cobre: ['pernas', 'pes'], x: -3, y: -9 },
    'SKIN_T2_CAVALEIRO.png': { x: -2, y: -8, scale: 0.97, cobre: ['pernas', 'pes'] },
    'SKIN_T2_EXECUTIVO.png': { x: 3, y: 7, scale: 1.02, cobre: ['pernas', 'pes'], recortes: [[180, 170, 147, 61], [194, 217, 16, 83]] },
    'SKIN_T2_LORDE.png': { cobre: ['pernas', 'pes'] },
    'SKIN_T2_OFICINA.png': { x: -2, y: -11, scale: 0.96, cobre: ['pernas', 'pes'] },
    'SKIN_T2_TATICO.png': { y: 1, cobre: ['pernas', 'pes'], recortes: [[175, 173, 154, 55], [188, 238, 114, 29]] },
    'SKIN_T2_TRILHA.png': { x: -2, y: -7, scale: 0.99, cobre: ['pes', 'pernas'] },
    'SKIN_T3_ALQUIMISTA.png': { x: 1, y: -9, cobre: ['bracos', 'pernas', 'pes'], cabelo: 'porBaixo' },
    'SKIN_T3_ATELIE.png': { cobre: ['pernas', 'pes'] },
    'SKIN_T3_CONDE.png': { cobre: ['pernas', 'pes'], x: -3, y: -11, scale: 1.05, porCorpo: { 'body_fem': { x: 1, y: 4, scale: 0.99 } } },
    'SKIN_T3_DUQUE.png': { cobre: ['pernas', 'pes'], porCorpo: { 'body_fem': { x: -1, y: 2, scale: 1.02 } } },
    'SKIN_T3_HIBRIDO.png': { x: 4, y: -8, cobre: ['pernas', 'pes', 'bracos'], cabelo: 'esconde' },
    'SKIN_T3_INVERNO.png': { cobre: ['pernas', 'pes'] },
    'SKIN_T3_NOMADE.png': { cobre: ['bracos', 'pernas', 'pes'], cabelo: 'porBaixo' },
    'SKIN_T3_NOTURNO.png': { cobre: ['pernas', 'pes'], porCorpo: { 'body_fem': { x: -1, y: -6 } } },
    'SKIN_T4_ARMADURA_PLACA.png': { y: -6, cobre: ['bracos', 'pernas', 'pes'], cabelo: 'esconde' },
    'SKIN_T4_EMPREENDEDOR.png': { cobre: ['pes', 'pernas'], porCorpo: { 'body_fem': { x: -3, y: 1, scale: 1.01 } } },
    'SKIN_T4_MAGO_CIRCULO.png': { x: 1, y: -4, scale: 1.02, cobre: ['pernas', 'pes'], recortes: [[174, 169, 144, 76]] },
    'SKIN_T4_PRINCIPE.png': { cobre: ['pes', 'pernas'], porCorpo: { 'body_fem': { x: -2 } } },
    'SKIN_T4_REI.png': { cobre: ['pernas', 'pes'], porCorpo: { 'body_fem': { x: -3, y: -1, scale: 1.02 } } },
    'SKIN_T5_SOBERANO.png': { cobre: ['pernas', 'pes'], porCorpo: { 'body_fem': { x: -3, y: -1 } } },
