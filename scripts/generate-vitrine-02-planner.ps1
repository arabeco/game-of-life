...
Draw-CenterText -Graphics $graphics -Text "O dia roda aqui." -Font $heroTitleFont -Brush $goldBrushSlide -X 164 -Y 398 -Width 752 -Height 170
Draw-CenterText -Graphics $graphics -Text "Quando a vida entra no Planner,`na execu${ccedilla}${atilde}o deixa de ser inten${ccedilla}${atilde}o.`nVira estrutura vis${iacute}vel." -Font $bodyFont -Brush $offWhiteBrush -X 194 -Y 630 -Width 692 -Height 126
Draw-Pill -Graphics $graphics -Text "Produto 02" -Font $bodyBoldFont -X 296 -Y 824 -Width 208 -Height 52
Draw-Pill -Graphics $graphics -Text "Planner" -Font $bodyBoldFont -X 524 -Y 824 -Width 212 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "O GLYPH liga`nArenas, prioridades`ne hor${aacute}rios." -Font $titleLargeFont -Brush $goldBrushSlide -X 276 -Y 500 -Width 528 -Height 164
Draw-CenterText -Graphics $graphics -Text "Voc${ecirc} puxa o que importa para o dia,`norganiza o foco por faixa hor${aacute}ria`ne enxerga a execu${ccedilla}${atilde}o em movimento." -Font $bodyFont -Brush $offWhiteBrush -X 286 -Y 686 -Width 508 -Height 146
Draw-CenterText -Graphics $graphics -Text "Menos lista. Mais fluxo." -Font $titleSmallFont -Brush $whiteBrush -X 300 -Y 828 -Width 480 -Height 60
