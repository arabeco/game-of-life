param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-05-a-arte-da-antecipacao\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-05-a-arte-da-antecipacao\assets"
...
$quoteText = "A suprema arte`nda guerra é derrotar`no inimigo sem lutar."
$supportCore = "O estrategista que ensinou o mundo a vencer antes do confronto."
$analysis1Title = "O que Sun Tzu fez?"
...
$analysis2Body = "Porque quase todos confundem força com choque.`nSun Tzu organizou a ideia de que inteligência, leitura e preparação podem decidir antes da luta começar."
...
Draw-CenterText -Graphics $graphics -Text "A Arte da Antecipação" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 05  |  A ARTE DA ANTECIPAÇÃO" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
