param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-15-a-arquitetura-de-um-sonho\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-15-a-arquitetura-de-um-sonho\assets"
...
Draw-Pill -Graphics $graphics -Text "Legado 15  |  Martin Luther King Jr." -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "A Arquitetura`nde um Sonho" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 15  |  Martin Luther King Jr." -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 15  |  A ARQUITETURA DE UM SONHO" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
