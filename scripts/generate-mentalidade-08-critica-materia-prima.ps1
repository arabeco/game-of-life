param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\mentalidade-08-critica-materia-prima\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Os grandes tratam`ncr${iacute}tica como`nmat${eacute}ria-prima." -Font $heroTitleFont -Brush $goldBrushSlide -X 138 -Y 286 -Width 804 -Height 388
Draw-CenterText -Graphics $graphics -Text "O mediano se ofende.`nA elite extrai dado." -Font $bodyFont -Brush $silverBrushSlide -X 170 -Y 720 -Width 740 -Height 116
Draw-Pill -Graphics $graphics -Text "Mentalidade 08" -Font $bodyBoldFont -X 382 -Y 836 -Width 316 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Ego" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 122 -Y 236 -Width 836 -Height 724
Draw-CenterText -Graphics $graphics -Text "Amadores ouvem`ncr${iacute}tica como ataque." -Font $titleLargeFont -Brush $goldBrushSlide -X 162 -Y 278 -Width 756 -Height 196
Draw-CenterText -Graphics $graphics -Text "Defendem a imagem, travam o corpo`ne desperdi${ccedilla}am informa${ccedilla}${atilde}o valiosa.`nO ego tenta sobreviver. A performance n${atilde}o cresce." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Ego ferido bloqueia refinamento." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Refino" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 122 -Y 236 -Width 836 -Height 730
Draw-CenterText -Graphics $graphics -Text "Os grandes filtram`no que serve." -Font $titleLargeFont -Brush $goldBrushSlide -X 154 -Y 256 -Width 772 -Height 246
Draw-CenterText -Graphics $graphics -Text "N${atilde}o engolem tudo nem imploram aprova${ccedilla}${atilde}o.`nSeparam ru${iacute}do de sinal e usam fric${ccedilla}${atilde}o`npara lapidar execu${ccedilla}${atilde}o, postura e clareza." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Cr${iacute}tica ${uacute}til vira combust${iacute}vel." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mentalidade 08  |  Os grandes tratam critica como materia-prima" -Font $eyebrowFont -Brush $eyebrowBrush -X 120 -Y 1060 -Width 840 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MENTALIDADE 08  |  OS GRANDES TRATAM CRITICA COMO MATERIA-PRIMA" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
