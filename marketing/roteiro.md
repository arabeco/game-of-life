...
O GLYPH nao fala sobre produtividade generica.
O GLYPH fala sobre soberania, sistema, execucao, legado e evolucao mensuravel.

Toda peca deve reforcar pelo menos um destes pilares:

- soberania pessoal
- disciplina como sistema
- medicao da vida real
...
Objetivo:
- Vender o diferencial concreto do produto: interface, sistema, customizacao, loja, legado, ouro, codex e experiencia premium.
...
Objetivo:
- Atrair pelo intelecto, pela friccao, pela verdade dura e pela estetica da marca.
...
O tom precisa parecer de Vanguarda, nao de coach.
...
### Vitrine 1: Skins e Customizacao de Perfil
...
Captura sugerida:
- Mostrar o menu de Arsenal com a troca de uma borda de avatar comum para uma borda dourada ou animada
...
### Filosofia 1: Reagir a vida vs Construir um Imperio
...
### Tatica 1: Como nivelar as 10 Areas da Vida
...
### Vitrine 2: Core Loop Fullscreen
...
### Filosofia 2: Por que a motivacao falha e a soberania diaria vence
...
### Tatica 2: Como blindar sua rotina noturna contra a dopamina barata
...
### Vitrine 3: O Sistema de Punicao, SITREP e a Trava de Compromisso
...
### Filosofia 3: O custo invisivel de viver a semana no piloto automatico
...
### Tatica 3: Gestao de Energia vs Gestao de Tempo
...
### Vitrine 4: A Forja e a Economia de Ouro
...
### Filosofia 4: O mito da multitarefa
...
### Filosofia 5: A dor da disciplina vs a dor do arrependimento
...
Stories nao entram nos 4 formatos fixos, mas seguem esta orientacao:

- usar prova social silenciosa
- mostrar print de ciclo fechado, arena concluida, card de legado ou radar
- texto minimo
- deixar curiosidade trabalhar

Exemplo:
- print de "Ciclo Fechado"
- sem explicacao longa
- objetivo: fazer a pessoa perguntar "que app e esse?"

## Regra final

Toda peca do GLYPH deve fazer o publico sentir uma destas coisas:

- quero isso
- preciso disso
- estou atrasado
- esse app parece serio
- isso nao e produtividade comum
