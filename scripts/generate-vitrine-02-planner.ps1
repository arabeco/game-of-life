...
Draw-Pill -Graphics $graphics -Text "Vitrine 02" -Font $bodyBoldFont -X 296 -Y 824 -Width 208 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "Vitrine 02  |  Planner e fluxo di${aacute}rio" -Font $eyebrowFont -Brush $eyebrowBrush -X 210 -Y 1060 -Width 660 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "VITRINE 02  |  PLANNER E FLUXO DI${Aacute}RIO" -Font ([System.Drawing.Font]::new($headlineFamily, 44, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
