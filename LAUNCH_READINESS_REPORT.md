...
- Generated at: 2026-09-01T22:49:25.243Z
- Suite: `core`
...
### PASS - Cycle comparison regression (3.0s)
- Kind: `logic`
...
### PASS - Subscription XP bonus regression (2.7s)
- Kind: `logic`
...
### PASS - Arena pacts regression (2.8s)
- Kind: `logic`
...
### PASS - Exp ledger regression (1.7s)
- Kind: `logic`
...
### PASS - Oracle reaction regression (2.6s)
- Kind: `logic`
...
### PASS - Sensory grammar regression (2.0s)
- Kind: `logic`
...
### PASS - Oracle arbiter regression (2.1s)
- Kind: `logic`
...
### PASS - Relationship link as timed product regression (2.1s)
- Kind: `logic`
...
### PASS - Onboarding happy path (57.5s)
- Kind: `browser`
