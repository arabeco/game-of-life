...
Draw-CenterText -Graphics $graphics -Text "Transformou rotina, técnica e resiliência`nem vantagem acumulada por anos." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
...
Draw-CenterText -Graphics $graphics -Text "Michael Phelps operava em rotina,`nrepeti${ccedilla}${atilde}o, precis${atilde}o e volume absurdo." -Font $bodySmallFont -Brush $offWhiteBrush -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
