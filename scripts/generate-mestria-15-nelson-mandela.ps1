...
Draw-CenterText -Graphics $graphics -Text "Mandela não mudou`nsó um regime." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 24) -Y ($slide2PanelY + 28) -Width ($slide2PanelWidth - 48) -Height 128
Draw-CenterText -Graphics $graphics -Text "Transformou dor, clareza e propósito`nem liderança capaz de sustentar reconciliação." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 26) -Y ($slide2PanelY + 176) -Width ($slide2PanelWidth - 52) -Height 194
Draw-CenterText -Graphics $graphics -Text "Princípio virou força.`nSacrifício virou direção." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 28) -Y ($slide2PanelY + 404) -Width ($slide2PanelWidth - 56) -Height 110
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Consciência`n10" -Body "Leitura alta de si,`ndo tempo e do peso`nde cada escolha." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Espaço mental`n10" -Body "Calma para manter`ndireção sem se`ncurvar ao caos." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Propósito`n10" -Body "Missão maior que`no ego, mantida por`ndécadas inteiras." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
