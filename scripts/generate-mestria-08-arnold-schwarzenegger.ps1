param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\mestria-08-arnold-schwarzenegger\slides"
)
...
$round6MestriaRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round8\mestria"
$round6FallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round8"
...
if ($round6MestriaAssets.Count -lt 3) {
    throw "Mestria 08 precisa de 3 imagens em marketing\\round8\\mestria ou marketing\\round8."
}
...
Draw-CenterText -Graphics $graphics -Text "Arnold Schwarzenegger" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
...
Draw-CenterText -Graphics $graphics -Text "Como o Glyph`nleria Arnold`nSchwarzenegger?" -Font $titleHugeFont -Brush $goldBrushSlide -X 94 -Y 392 -Width 592 -Height 448
Draw-Pill -Graphics $graphics -Text "N${Iacute}vel de maestria 89" -Font $bodyBoldFont -X 186 -Y 860 -Width 392 -Height 56
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} s${oacute} for${ccedilla}a.`n${Eacute} estrat${eacute}gia, imagem e expans${atilde}o." -Font $titleMediumFont -Brush $silverBrushSlide -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Arnold Schwarzenegger" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 90 -Y 128 -Width 900 -Height 120
$slide2PanelX = 118
$slide2PanelY = 334
...
Draw-CenterText -Graphics $graphics -Text "Arnold n${Atilde}o venceu`ns${oacute} no f${iacute}sico." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Transformou corpo, carreira, dinheiro`ne narrativa p${uacute}blica em`num mesmo projeto de poder." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Disciplina virou identidade.`nEscala virou m${eacute}todo." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-CenterText -Graphics $graphics -Text "Arnold Schwarzenegger" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
Draw-CenterText -Graphics $graphics -Text "For${ccedilla}a, trabalho`ne expans${atilde}o." -Font $titleLargeFont -Brush $goldBrushSlide -X 120 -Y 232 -Width 626 -Height 176
Draw-ClippedImageBox -Graphics $graphics -ImagePath $cr7Slide3Path -X 738 -Y 184 -Width 214 -Height 254 -Opacity 0.98 -AlignBottom
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "F${iacute}sico`n10" -Body "O corpo virou`nplataforma de`nmaestria e prova." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Repeti${ccedilla}${atilde}o brutal`nat${eacute} a execu${ccedilla}${atilde}o`nvirar padr${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Projetos`n10" -Body "Cinema, neg${oacute}cios`ne pol${iacute}tica sem`nmentalidade de`nsegunda arena." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "F${iacute}sico, Trabalho e Projetos.`nA musculatura era s${oacute} o primeiro imp${eacute}rio." -Font $bodyFont -Brush $mutedBrush -X 150 -Y 964 -Width 780 -Height 104
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Arnold expandiu o pr${oacute}prio radar:`nfor${ccedilla}a, carreira, capital e influ${ecirc}ncia." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mestria 08  |  Arnold Schwarzenegger" -Font $eyebrowFont -Brush $eyebrowBrush -X 148 -Y 1060 -Width 784 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 08  |  ARNOLD SCHWARZENEGGER" -Font ([System.Drawing.Font]::new($headlineFamily, 40, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
