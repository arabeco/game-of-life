...
Draw-CenterText -Graphics $graphics -Text "No GLYPH, progresso tamb${eacute}m fala.`nO Or${aacute}culo transforma sinais em leitura." -Font $bodyFont -Brush $silverBrushSlide -X 142 -Y 642 -Width 796 -Height 196
Draw-Pill -Graphics $graphics -Text "Produto 09" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "O Or${aacute}culo cruza o momento, os padr${otilde}es`ne o contexto do ciclo para devolver dire${ccedilla}${atilde}o.`nN${atilde}o ${eacute} s${oacute} dado. ${Eacute} interpreta${ccedilla}${atilde}o." -Font $bodyFont -Brush $silverBrushSlide -X 176 -Y 676 -Width 728 -Height 236
...
Draw-CenterText -Graphics $graphics -Text "Produto 09  |  O Oraculo, conselhos, analise e feed" -Font $eyebrowFont -Brush $eyebrowBrush -X 108 -Y 1060 -Width 864 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 09  |  ORACULO, CONSELHOS, ANALISE E FEED" -Font ([System.Drawing.Font]::new($headlineFamily, 38, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
