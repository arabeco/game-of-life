param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\produto-15-painel-diario-sitrep\\slides",
    [string]$Screen1Path = "",
    [string]$Screen2Path = ""
)
...
$proofRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round15\\produto"
$proofFallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round15"
...
function Get-PrintLabel {
    ...
    switch ($base) {
        ...
        "placa legado" { return "Placa" }
        "placa" { return "Placa" }
        "planner" { return "Planner" }
        "arenas2" { return "Arenas" }
        "arenamodal" { return "Arena" }
        "maestria" { return "Quiz" }
        "maestria2" { return "Resultado" }
        "codexes2" { return "Biblioteca" }
        "acaomodal" { return "Ação" }
        "acoes2" { return "Ações" }
        "paineldiario" { return "Painel diário" }
        "tela de descanso" { return "Descanso" }
        "relatorioresumo" { return "Resumo" }
        "relatoriocard" { return "Card final" }
        default {
...
# PadrÃ£o-base da Produto: uma coluna editorial e uma coluna de destaque
...
Draw-CenterText -Graphics $graphics -Text "SITREP" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 132 -Width 912 -Height 180
Draw-CenterText -Graphics $graphics -Text "Todo dia pede`nabertura,`nfricção e fecho." -Font $heroTitleFont -Brush $goldBrushSlide -X 134 -Y 332 -Width 812 -Height 246
Draw-CenterText -Graphics $graphics -Text "O Painel Diário transforma o dia em ciclo consciente.`nAbrir, sustentar, enfrentar e encerrar." -Font $bodyFont -Brush $offWhiteBrush -X 142 -Y 652 -Width 796 -Height 196
Draw-Pill -Graphics $graphics -Text "Produto 15" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
Draw-Pill -Graphics $graphics -Text "SITREP" -Font $bodyBoldFont -X 536 -Y 858 -Width 248 -Height 52
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgSapphire -Width $width -Height $height -Tone "safira"
Draw-CenterText -Graphics $graphics -Text "Ritual" -Font $watermarkFont -Brush $goldWashBrush -X 86 -Y 118 -Width 908 -Height 180
...
Draw-CenterText -Graphics $graphics -Text "Abertura,`ntrava e retorno." -Font $titleLargeFont -Brush $goldBrushSlide -X 196 -Y 384 -Width 688 -Height 236
Draw-CenterText -Graphics $graphics -Text "Você entra no dia com contexto, acompanha o que importa`ne fecha sem se esconder do resultado." -Font $bodyFont -Brush $offWhiteBrush -X 176 -Y 676 -Width 728 -Height 236
Draw-CenterText -Graphics $graphics -Text "Disciplina diária é arquitetura de longo prazo." -Font $titleSmallFont -Brush $whiteBrush -X 174 -Y 936 -Width 732 -Height 84
...
for ($proofPage = 0; $proofPage -lt $proofPageCount; $proofPage++) {
    ...
    $graphics = $canvas.Graphics
    Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgSapphire -Width $width -Height $height -Tone "safira"
    Draw-CenterText -Graphics $graphics -Text "Telas reais de`nSITREP e Ritual." -Font $titleLargeFont -Brush $goldBrushSlide -X 124 -Y 150 -Width 832 -Height 110
    ...
    if ($currentPair.Count -ge 2) {
        ...
        Draw-PhoneSlot -Graphics $graphics -X 164 -Y 318 -Width $proofPhoneSlotWidth -Height 560 -ImagePath $leftPath -Title $leftLabel -Subtitle "Tela real do sistema" -TitleFont $titleSmallFont -SubtitleFont $bodySmallFont -TitleBrush $goldBrushSlide -SubtitleBrush $mutedBrush -LogoPath $logoPath
        Draw-PhoneSlot -Graphics $graphics -X 656 -Y 318 -Width $proofPhoneSlotWidth -Height 560 -ImagePath $rightPath -Title $rightLabel -Subtitle "Tela real do sistema" -TitleFont $titleSmallFont -SubtitleFont $bodySmallFont -TitleBrush $goldBrushSlide -SubtitleBrush $mutedBrush -LogoPath $logoPath
        ...
        Draw-PhoneSlot -Graphics $graphics -X 393 -Y 290 -Width 294 -Height 640 -ImagePath $singlePath -Title $singleLabel -Subtitle "Tela real do sistema" -TitleFont $titleSmallFont -SubtitleFont $bodySmallFont -TitleBrush $goldBrushSlide -SubtitleBrush $mutedBrush -LogoPath $logoPath
...
Draw-CenterText -Graphics $graphics -Text "Produto 15  |  Clas, quests e operacao coletiva" -Font $eyebrowFont -Brush $eyebrowBrush -X 148 -Y 1060 -Width 784 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 15  |  PAINEL DIÁRIO, SITREP" -Font ([System.Drawing.Font]::new($headlineFamily, 38, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
