-- O bau Lendario volta a pagar fragmentos.
--
-- Ate 20260818 o tipo 'Lendario' era NORMALIZADO para 'season': os dois eram o
-- mesmo bau por dentro, e o lendario herdava o bonus de 200-500 fragmentos.
-- A migracao 20260818150000 separou os dois e deu ao 'lendario' ramo proprio na
-- curva de tiers, no pity e no contador — mas nao no bonus de fragmentos. Desde
-- entao ele cai no `else 0`.
--
-- O efeito: o QUINTO degrau da escada paga menos que o SEGUNDO.
--
--   Comum      0
--   Incomum    5-15
--   Ciclo      10-30
...
--   Mitico     200-500
--
-- Nada disso da erro. Quem abre um Lendario acha que teve azar.
--
-- 150-350 fica entre o Epico e o Mitico, no mesmo ritmo em que a escada cresce.
-- O resto da funcao e copia literal de 20260820140000: so esta linha muda.
...
begin
  ...
  v_bonus_fragments := case v_chest_type
    ...
    -- O degrau que faltava. Ver o cabecalho: sem esta linha o Lendario caia
    -- no else e pagava ZERO, menos que o Incomum.
