param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-02-o-ritual-de-descompressao-noturna\slides"
)
...
$coverSupport = "O dia não termina sozinho.`nO corpo precisa ser avisado."
...
Draw-CenterText -Graphics $graphics -Text "O Ritual de Descompressão Noturna" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 02  |  O RITUAL DE DESCOMPRESSÃO NOTURNA" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
