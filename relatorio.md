...
- Tudo que estava em `v` e `x` foi movido para [progresso.md](/C:/Users/Afonso/Downloads/GOL1.006/progresso.md).
...
2. No item 4:
   - `[ ]` = pendente
   - `[-]` = visto hoje / em revisao
   - `[x]` = fechado neste ciclo
3. Quando um bloco fechar de verdade, mover para `progresso.md`.
