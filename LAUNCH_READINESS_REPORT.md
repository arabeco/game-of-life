...
- Generated at: 2026-09-09T20:19:07.192Z
- Suite: `core`
...
### PASS - Avatar offsets regression (1.1s)
- Kind: `logic`
...
### PASS - Reward modal regression (0.3s)
- Kind: `logic`
...
### PASS - Cycle comparison regression (0.4s)
- Kind: `logic`
...
### PASS - Subscription XP bonus regression (0.6s)
- Kind: `logic`
...
### PASS - Arena pacts regression (0.6s)
- Kind: `logic`
...
### PASS - Cycle scheduling regression (0.3s)
- Kind: `logic`
...
### PASS - Exp ledger regression (0.3s)
- Kind: `logic`
...
### PASS - Oracle reaction regression (0.4s)
- Kind: `logic`
...
### PASS - Sensory grammar regression (0.4s)
- Kind: `logic`
...
### PASS - Oracle arbiter regression (0.5s)
- Kind: `logic`
...
### PASS - Relationship link as timed product regression (0.5s)
- Kind: `logic`
...
### PASS - Onboarding happy path (26.4s)
- Kind: `browser`
