param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-12-hidratacao-matinal-antes-de-tudo\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Hidratação matinal`nantes de tudo" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-Pill -Graphics $graphics -Text "Fundamentos 12" -Font $bodyBoldFont -X 386 -Y 790 -Width 308 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Fundamentos 12  |  Descanso falso vs. descanso real" -Font $eyebrowFont -Brush $eyebrowBrush -X 98 -Y 1060 -Width 884 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 12  |  HIDRATAÇÃO MATINAL ANTES DE TUDO" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
