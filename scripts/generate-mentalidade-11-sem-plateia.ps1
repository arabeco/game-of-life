param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\mentalidade-11-sem-plateia\\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Os grandes treinam`nsem precisar`nde plateia." -Font $heroTitleFont -Brush $goldBrushSlide -X 138 -Y 286 -Width 804 -Height 388
Draw-CenterText -Graphics $graphics -Text "Amador precisa ser visto.`nElite precisa ficar pronta." -Font $bodyFont -Brush $silverBrushSlide -X 170 -Y 720 -Width 740 -Height 116
Draw-Pill -Graphics $graphics -Text "Mentalidade 11" -Font $bodyBoldFont -X 382 -Y 836 -Width 316 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Aplauso" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 122 -Y 236 -Width 836 -Height 724
Draw-CenterText -Graphics $graphics -Text "Quem depende`nde validação`nperde ritmo." -Font $titleLargeFont -Brush $goldBrushSlide -X 162 -Y 278 -Width 756 -Height 196
Draw-CenterText -Graphics $graphics -Text "Se a energia vem da plateia, o padrão some no silêncio.`nEvolução séria não pode depender de testemunha." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Vaidade atrasa. Treino cala." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Forja" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 458 -Width 912 -Height 150
Draw-EditorialPanel -Graphics $graphics -X 122 -Y 236 -Width 836 -Height 730
Draw-CenterText -Graphics $graphics -Text "Gente world class`nrepete no escuro." -Font $titleLargeFont -Brush $goldBrushSlide -X 154 -Y 256 -Width 772 -Height 246
Draw-CenterText -Graphics $graphics -Text "Os melhores constroem força longe do elogio.`nQuando aparece a vitrine, o trabalho já está feito." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "O invisível sustenta o extraordinário." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mentalidade 11  |  Gente world class pensa em decadas, nao em humores" -Font $eyebrowFont -Brush $eyebrowBrush -X 58 -Y 1060 -Width 964 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MENTALIDADE 11  |  OS GRANDES TREINAM SEM PRECISAR DE PLATEIA" -Font ([System.Drawing.Font]::new($headlineFamily, 24, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
