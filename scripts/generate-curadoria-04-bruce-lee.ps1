param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\curadoria-04-bruce-lee\slides"
)
...
$cr7CoverPath = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round 4\image-removebg-preview - 2026-03-18T212925.960.png"
$cr7PanelPath = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round 4\image-removebg-preview - 2026-03-18T212815.079.png"
$cr7Slide3Path = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round 4\image-removebg-preview - 2026-03-18T213007.822.png"
...
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} mito.`n${Eacute} disciplina com inten${ccedilla}${atilde}o." -Font $titleMediumFont -Brush $silverBrushSlide -X 104 -Y 980 -Width 620 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Bruce n${Atilde}o treinava`ns${oacute} o corpo." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Treinava rea${ccedilla}${atilde}o, clareza, linguagem`ne filosofia at${eacute} a disciplina`nvirar identidade." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Pot${ecirc}ncia sem consci${ecirc}ncia`n${eacute} s${oacute} ru${iacute}do." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Prop${oacute}sito`n10" -Body "Presen${ccedilla}a total.`nRea${ccedilla}${atilde}o limpa`nsem ru${iacute}do." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Prop${oacute}sito`n10" -Body "A arte virou`nmensagem, m${eacute}todo`ne dire${ccedilla}${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
...
Draw-CenterText -Graphics $graphics -Text "Bruce Lee n${Atilde}o era s${oacute} t${eacute}cnica.`nEra sistema inteiro em movimento." -Font $bodySmallFont -Brush $silverBrushSlide -X 190 -Y 1012 -Width 700 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
