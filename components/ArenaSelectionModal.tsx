            ...
            <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-[110] flex items-center justify-center animate-fade-in" onClick={onClose}>
                <GlassCard variant="neutral" className="w-full max-w-sm m-4 space-y-4 rounded-3xl" onClick={e => e.stopPropagation()}>
                    <div className="flex justify-between items-center">
                        <h2 className="text-lg font-bold uppercase tracking-wider text-center flex-1">
                    ...
                    {isCreating ? (
                        <div className="space-y-4">
                            ...
                            <div>
                                <label className="text-xs font-semibold text-gray-400 uppercase">Ativo pai</label>
                                <div className="grid grid-cols-2 gap-2 mt-1">
                                    {assets.filter(asset => asset.id !== 'geral').map(asset => (
                                        <button
                                            key={asset.id}
                            ...
                            <button
                                ...
                                className="w-full py-3 luxe-bico luxe-skin-button disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                Criar Arena
                            </button>
                        </div>
                        ...
                        <>
                            ...
                            >
                                ...
                                <span className="font-bold uppercase text-sm">Nova Arena</span>
                            </button>
                        </>
                    )}
                </GlassCard>
