param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-06-a-precisa-o-invisa-vel\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-06-a-precisa-o-invisa-vel\assets"
...
$quoteText = "Sou tÃ£o boa`nquanto qualquer um,`nmas nÃ£o melhor."
$supportCore = "A matemÃ¡tica cujos cÃ¡lculos ajudaram a colocar a exploraÃ§Ã£o espacial em pÃ©."
$analysis1Title = "O que Viktor Frankl fez?"
$analysis1 = "Katherine Johnson calculou, Ã  mÃ£o, trajetÃ³rias orbitais e janelas de reentrada nas primeiras missÃµes espaciais dos Estados Unidos.`nEm um ambiente hostil a mulheres negras, sua precisÃ£o sustentou missÃµes crÃ­ticas."
$analysis1Close = "Sem aparecer, ela sustentou a trajetÃ³ria."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque o trabalho decisivo dela acontecia onde quase ninguÃ©m olha: nos nÃºmeros certos, na hora certa, sem margem para erro.`nGrandeza silenciosa, mas estrutural."
$analysis2Close = "Ela provou que precisÃ£o tambÃ©m Ã© heroÃ­smo."
...
Draw-Pill -Graphics $graphics -Text "Legado 06  |  Katherine Johnson" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "A PrecisÃ£o`nInvisÃ­vel" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 06  |  Katherine Johnson" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 06  |  A PRECISÃ£O INVISÃ­VEL" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
