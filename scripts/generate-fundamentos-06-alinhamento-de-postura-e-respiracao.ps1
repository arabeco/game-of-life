param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-06-alinhamento-de-postura-e-respiracao\slides"
)
...
$coverSupport = "�?s vezes a mente não está ruim.`nO corpo é que está comprimido."
...
$logic2Body = "Abrir peito, soltar cervical e respirar fundo por alguns ciclos devolve oxigênio, presença e margem de decisão.`n�?s vezes o reset começa por centímetros."
...
Draw-CenterText -Graphics $graphics -Text "Alinhamento de Postura e Respiração" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 06  |  ALINHAMENTO DE POSTURA E RESPIRAÇÃO" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
