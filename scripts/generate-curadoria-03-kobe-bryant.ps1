param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\curadoria-03-kobe-bryant\slides"
)
...
$cr7CoverPath = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round3\image-removebg-preview - 2026-03-18T201845.988.png"
$cr7PanelPath = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round3\image-removebg-preview - 2026-03-18T202015.484.png"
$cr7Slide3Path = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round3\image-removebg-preview - 2026-03-18T202026.575.png"
...
Draw-CenterText -Graphics $graphics -Text "Como o Glyph`nleria Kobe`nBryant?" -Font $titleHugeFont -Brush $goldBrushSlide -X 104 -Y 402 -Width 560 -Height 430
Draw-Pill -Graphics $graphics -Text "N${Iacute}vel de maestria 87" -Font $bodyBoldFont -X 186 -Y 860 -Width 392 -Height 56
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} nostalgia.`n${Eacute} execu${ccedilla}${atilde}o em padr${atilde}o." -Font $titleMediumFont -Brush $silverBrushSlide -X 104 -Y 980 -Width 620 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Kobe Bryant" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 90 -Y 128 -Width 900 -Height 120
$slide2PanelX = 118
$slide2PanelY = 334
...
$slide2FrameWidth = Get-FeatureFrameWidth -ImagePath $cr7PanelPath -FrameHeight $slide2FrameHeight -InnerHorizontalPadding 38 -InnerVerticalPadding 18 -MinWidth 226 -MaxWidth 258
$slide2FrameX = [float](950 - $slide2FrameWidth)
Draw-EditorialTextPanel -Graphics $graphics -X $slide2PanelX -Y $slide2PanelY -Width $slide2PanelWidth -Height $slide2PanelHeight
Draw-CenterText -Graphics $graphics -Text "Kobe n${Atilde}o virou lenda`npor talento solto." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Virou porque transformou treino, dor,`nrepeti${ccedilla}${atilde}o e press${atilde}o`nem padr${atilde}o di${aacute}rio." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 188) -Width ($slide2PanelWidth - 40) -Height 210
Draw-CenterText -Graphics $graphics -Text "Mamba n${Atilde}o ${eacute} pose.`n${Eacute} execu${ccedilla}${atilde}o." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 98
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "F${iacute}sico`n10" -Body "O corpo virou`npadr${atilde}o alto`nde execu${ccedilla}${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Treino cedo,`nfundamento repetido`ne padr${atilde}o brutal." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Espa${ccedilla}o mental`n10" -Body "Ru${iacute}do zerado.`nFoco obsessivo`nno alvo presente." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "F${iacute}sico, Trabalho e Espa${ccedilla}o mental.`nA Mamba Mentality virou sistema." -Font $bodyFont -Brush $mutedBrush -X 150 -Y 964 -Width 780 -Height 104
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "87" -Font $monoTitleFont -Brush $whiteBrush -X 350 -Y 174 -Width 380 -Height 180
$labels = @(
    "Consci${ecirc}ncia",
...
$values = @(8,10,7,10,8,8,8,10,8,10)
...
Draw-CenterText -Graphics $graphics -Text "A Mamba Mentality n${Atilde}o ${eacute} slogan.`n${Eacute} sistema de execu${ccedilla}${atilde}o repetido por anos." -Font $bodySmallFont -Brush $silverBrushSlide -X 190 -Y 1012 -Width 700 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mestria 03  |  Kobe Bryant" -Font $eyebrowFont -Brush $eyebrowBrush -X 220 -Y 1060 -Width 640 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 03  |  KOBE BRYANT" -Font ([System.Drawing.Font]::new($headlineFamily, 46, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
