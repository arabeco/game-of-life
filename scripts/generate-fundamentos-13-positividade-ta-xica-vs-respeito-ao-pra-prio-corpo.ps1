param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-13-positividade-ta-xica-vs-respeito-ao-pra-prio-corpo\slides"
)
...
$coverSupport = "Nem toda cobranÃ§a interna Ã© disciplina. Ã€s vezes Ã© negaÃ§Ã£o."
$logic1Title = "ForÃ§ar sempre`nnÃ£o Ã© maturidade."
$logic1Body = "Quando cansaÃ§o, dor ou saturaÃ§Ã£o aparecem, muita gente responde com culpa vestida de superaÃ§Ã£o.`nO discurso parece forte, mas muitas vezes sÃ³ mascara desconexÃ£o do prÃ³prio corpo."
$logic1Close = "Produtividade sem escuta pode ser autossabotagem elegante."
$logic2Title = "Respeitar o corpo`nnÃ£o enfraquece."
$logic2Body = "A pausa certa, o ajuste certo e o ritmo certo preservam capacidade de longo prazo.`nIgnorar sinal nÃ£o Ã© bravura. Ã‰ cobranÃ§a burra com estÃ©tica de virtude."
$logic2Close = "Escuta madura sustenta mais que heroÃ­smo cego."
...
Draw-CenterText -Graphics $graphics -Text "Positividade tÃ³xica`nvs.`nrespeito ao prÃ³prio corpo" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 13  |  POSITIVIDADE TÃ³XICA VS. RESPEITO AO PRÃ³PRIO CORPO" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
