...
Draw-CenterText -Graphics $graphics -Text "Amadores esperam aval.`nOs melhores ocupam o campo." -Font $bodyFont -Brush $silverBrushSlide -X 170 -Y 720 -Width 740 -Height 116
...
Draw-CenterText -Graphics $graphics -Text "Pedem consenso, ambiente ideal e ben${ccedilla}${atilde}o coletiva.`nTransformam depend${ecirc}ncia em prud${ecirc}ncia`ne terceirizam o pr${oacute}prio eixo." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Quem espera demais j${aacute} entregou o comando." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Nao confundem respeito com submiss${atilde}o.`nEntram em movimento antes do aplauso`ne deixam o resultado falar depois." -Font $bodyFont -Brush $silverBrushSlide -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Movimento vem antes da aprova${ccedilla}${atilde}o." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 798 -Width 728 -Height 92
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
