param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-13-positividade-toxica-vs-respeito-ao-proprio-corpo\slides"
)
...
Draw-SubtleGoldShimmer -Graphics $graphics -CenterX 744 -CenterY 446 -BandWidth 236 -BandHeight 1520 -Angle 15 -PeakAlpha 14
Draw-CenterText -Graphics $graphics -Text "Fundamentos" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 76 -Width 912 -Height 120
Draw-CenterText -Graphics $graphics -Text "Positividade tóxica`nvs.`nrespeito ao próprio corpo" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
Draw-CenterText -Graphics $graphics -Text $coverSupport -Font $bodyFont -Brush $silverBrushSlide -X 152 -Y 566 -Width 776 -Height 144
Draw-Pill -Graphics $graphics -Text "Fundamentos 13" -Font $bodyBoldFont -X 386 -Y 790 -Width 308 -Height 54
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgFoundations -Width $width -Height $height
Draw-SubtleGoldShimmer -Graphics $graphics -CenterX 860 -CenterY 612 -BandWidth 196 -BandHeight 1560 -Angle -17 -PeakAlpha 12
...
Draw-CenterText -Graphics $graphics -Text $logic1Body -Font $bodyFont -Brush $silverBrushSlide -X 122 -Y 466 -Width 836 -Height 304
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgFoundations -Width $width -Height $height
Draw-SubtleGoldShimmer -Graphics $graphics -CenterX 356 -CenterY 654 -BandWidth 220 -BandHeight 1560 -Angle 18 -PeakAlpha 12
...
Draw-CenterText -Graphics $graphics -Text $logic2Body -Font $bodyFont -Brush $silverBrushSlide -X 122 -Y 470 -Width 836 -Height 320
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgFoundations -Width $width -Height $height
Draw-SubtleGoldShimmer -Graphics $graphics -CenterX 670 -CenterY 584 -BandWidth 208 -BandHeight 1520 -Angle -13 -PeakAlpha 11
...
Draw-CenterText -Graphics $graphics -Text "Fundamentos 13  |  Descanso falso vs. descanso real" -Font $eyebrowFont -Brush $eyebrowBrush -X 98 -Y 1060 -Width 884 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 13  |  POSITIVIDADE TÓXICA VS. RESPEITO AO PRÓPRIO CORPO" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
