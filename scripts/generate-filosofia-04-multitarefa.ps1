param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\filosofia-04-mito-da-multitarefa\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "O mito da`nmultitarefa." -Font $heroTitleFont -Brush $marfimTitleBrush -X 156 -Y 346 -Width 768 -Height 238
Draw-CenterText -Graphics $graphics -Text "Fazer tudo ao mesmo tempo ${eacute} a forma mais elegante`nde fazer tudo pior." -Font $bodyFont -Brush $offWhiteBrush -X 170 -Y 642 -Width 740 -Height 124
Draw-Pill -Graphics $graphics -Text "Filosofia 04" -Font $bodyBoldFont -X 404 -Y 814 -Width 272 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Filosofia 04  |  O mito da multitarefa" -Font $eyebrowFont -Brush $eyebrowBrush -X 180 -Y 1060 -Width 720 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FILOSOFIA 04  |  O MITO DA MULTITAREFA" -Font ([System.Drawing.Font]::new($headlineFamily, 42, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
