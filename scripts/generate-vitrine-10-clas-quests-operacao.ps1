...
Draw-CenterText -Graphics $graphics -Text "No GLYPH, alian${ccedilla}a tamb${eacute}m vira sistema.`nCl${atilde}s, quests e opera${ccedilla}${atilde}o coletiva." -Font $bodyFont -Brush $silverBrushSlide -X 142 -Y 652 -Width 796 -Height 196
Draw-Pill -Graphics $graphics -Text "Produto 10" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "Entrar em cl${atilde}, operar com aliados e subir`nem quests de temporada transforma esfor${ccedilla}o`nem campanha coletiva com identidade propria." -Font $bodyFont -Brush $silverBrushSlide -X 176 -Y 676 -Width 728 -Height 236
...
Draw-CenterText -Graphics $graphics -Text "Produto 10  |  Clas, quests e operacao coletiva" -Font $eyebrowFont -Brush $eyebrowBrush -X 148 -Y 1060 -Width 784 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 10  |  CLAS, QUESTS E OPERACAO COLETIVA" -Font ([System.Drawing.Font]::new($headlineFamily, 38, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
