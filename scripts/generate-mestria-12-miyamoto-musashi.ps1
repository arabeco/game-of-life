...
Draw-CenterText -Graphics $graphics -Text "Transformou disciplina, observação e frieza`nem vantagem antes do confronto começar." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
