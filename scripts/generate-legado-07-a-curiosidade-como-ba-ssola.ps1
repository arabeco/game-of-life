param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-07-a-curiosidade-como-ba-ssola\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-07-a-curiosidade-como-ba-ssola\assets"
...
$quoteText = "A imaginaÃ§Ã£o Ã© mais`nimportante que o conhecimento."
$supportCore = "O fÃ­sico que mexeu na ideia de tempo, espaÃ§o e realidade."
$analysis1Title = "O que Viktor Frankl fez?"
$analysis1 = "Albert Einstein reformulou a fÃ­sica ao propor a relatividade, deslocando a compreensÃ£o de espaÃ§o, tempo, luz e gravidade.`nEle nÃ£o apenas resolveu problemas: mudou o tabuleiro sobre o qual a ciÃªncia fazia perguntas."
$analysis1Close = "Ele expandiu o que o intelecto humano podia alcanÃ§ar."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque nÃ£o basta ser inteligente: Ã© preciso ver o que ninguÃ©m estava conseguindo formular.`nEinstein abriu uma nova arquitetura mental para interpretar o real."
$analysis2Close = "Ele pensou alÃ©m da moldura do seu sÃ©culo."
...
Draw-Pill -Graphics $graphics -Text "Legado 07  |  Albert Einstein" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "A Curiosidade`ncomo BÃºssola" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 07  |  Albert Einstein" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 07  |  A CURIOSIDADE COMO BÃºSSOLA" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
