param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-14-a-progressa-o-inabala-vel\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-14-a-progressa-o-inabala-vel\assets"
...
$quoteText = "NÃ£o importa o quÃ£o devagar`nvocÃª vÃ¡, desde que`nvocÃª nÃ£o pare."
$supportCore = "O filÃ³sofo que moldou Ã©tica, lideranÃ§a e educaÃ§Ã£o por milÃªnios."
$analysis1Title = "O que ConfÃºcio fez?"
$analysis1 = "ConfÃºcio organizou um corpo de ensinamentos sobre moralidade, disciplina, conduta e governo que atravessou sÃ©culos e moldou civilizaÃ§Ãµes inteiras na Ãsia.`nSua influÃªncia nÃ£o foi episÃ³dica. Foi estrutural."
$analysis1Close = "Ele nÃ£o venceu por estrondo. Venceu por permanÃªncia."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque existem ideias que brilham e somem. As dele entraram no comportamento, na polÃ­tica, na educaÃ§Ã£o e no ideal de lideranÃ§a.`nIsso Ã© impacto de profundidade rara."
$analysis2Close = "Ele transformou consistÃªncia em civilizaÃ§Ã£o."
...
Draw-Pill -Graphics $graphics -Text "Legado 14  |  ConfÃºcio" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "A ProgressÃ£o`nInabalÃ¡vel" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 14  |  ConfÃºcio" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 14  |  A PROGRESSÃ£O INABALÃ¡VEL" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
