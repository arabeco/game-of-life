    ...
    quests: [
      {
        ...
        actionTemplate: { name: 'Caminhada (1km)', description: 'Caminhar 1km em ritmo constante.', duration: 15, icon: 'ðŸš¶', repetitions: 20 },
      ...
      },
      {
        ...
        season_id: 'season-genesis-0',
        actionTemplate: { name: 'Leitura Focada', description: 'Ler um livro com atencao plena.', duration: 30, icon: 'ðŸ“š', repetitions: 15, isMilestone: true },
      ...
      },
      {
        ...
        category: 'physical',
        season_id: 'season-genesis-0',
        actionTemplate: { name: 'Flexoes (x10)', description: 'Fazer 10 flexoes com boa forma.', duration: 5, icon: 'ðŸ’ª', repetitions: 5 },
    ...
    quests: [
      {
        ...
        description: 'Complete 12 travessias de 2 km para firmar o corpo no amanhecer da Primeira Era. Recompensa: 1 BaÃº Season.',
        type: 'individual',
        category: 'physical',
      ...
      },
      {
        ...
        description: 'Feche 12 sessoes de leitura focada para abrir clareza mental no ciclo da Aurora. Recompensa: 1 BaÃº Season.',
        type: 'individual',
        category: 'intellectual',
        season_id: 'season-aurora-1-2026',
        actionTemplate: {
      ...
      },
      {
        ...
        description: 'Feche 15 praticas de meditacao para atravessar a Aurora com presenca e silencio. Recompensa: 1 BaÃº Season.',
        type: 'individual',
        category: 'spiritual',
        season_id: 'season-aurora-1-2026',
        actionTemplate: {
