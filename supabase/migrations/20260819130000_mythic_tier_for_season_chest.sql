-- O bau Mitico passa a sortear o tier 6, que so itens de temporada usam.
--
-- Antes ele rolava tier 4 em 60% e tier 5 em 40%. Como nenhum item de
-- temporada era tier 5, esses 40% escorregavam pela ultima rede do sorteio e
-- entregavam um lendario qualquer do acervo normal - o bau de temporada era,
-- quatro em cada dez vezes, um bau lendario com outro nome.
--
-- Com Mitico sendo tier 6, a separacao passa a ser estrutural: nenhum outro
-- bau rola 6, e nenhum item de temporada vive fora dele. O filtro
-- is_season_exclusive continua ali, agora como cinto e suspensorio.
