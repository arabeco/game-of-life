param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-12-hidrataa-a-o-matinal-antes-de-tudo\slides"
)
...
$logic1Title = "A manhÃ£ comeÃ§a`npelo bÃ¡sico."
$logic1Body = "Depois de horas dormindo, o corpo acorda pedindo Ã¡gua, nÃ£o estÃ­mulo complexo.`nComeÃ§ar direto com cafÃ©, tela e correria empurra o organismo para demanda antes de devolver base."
$logic1Close = "Sistema seco responde pior."
$logic2Title = "Ãgua primeiro`nÃ© sinal de ordem."
$logic2Body = "Um copo grande ao acordar ajuda a religar digestÃ£o, circulaÃ§Ã£o e sensaÃ§Ã£o de presenÃ§a fÃ­sica.`nNÃ£o parece Ã©pico. Mas Ã© o tipo de fundamento que melhora o resto do dia sem alarde."
...
Draw-CenterText -Graphics $graphics -Text "HidrataÃ§Ã£o matinal`nantes de tudo" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 12  |  HIDRATAÃ§Ã£O MATINAL ANTES DE TUDO" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
