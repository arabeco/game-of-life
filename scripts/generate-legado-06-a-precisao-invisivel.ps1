param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-06-a-precisao-invisivel\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-06-a-precisao-invisivel\assets"
...
$quoteText = "Sou tão boa`nquanto qualquer um,`nmas não melhor."
$supportCore = "A matemática cujos cálculos ajudaram a colocar a exploração espacial em pé."
$analysis1Title = "O que Katherine Johnson fez?"
...
$analysis2Body = "Porque o trabalho decisivo dela acontecia onde quase ninguém olha: nos números certos, na hora certa, sem margem para erro.`nGrandeza silenciosa, mas estrutural."
...
Draw-CenterText -Graphics $graphics -Text "A Precisão Invisível" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 06  |  A PRECISÃO INVISÍVEL" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
