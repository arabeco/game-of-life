...
Draw-CenterText -Graphics $graphics -Text "No GLYPH, ciclos fechados n${atilde}o evaporam.`nEles viram cards, mem${oacute}ria visual`ne prova export${aacute}vel da evolu${ccedilla}${atilde}o." -Font $bodyFont -Brush $silverBrushSlide -X 142 -Y 652 -Width 796 -Height 196
...
Draw-CenterText -Graphics $graphics -Text "Ciclo encerrado vira pe${ccedilla}a, mem${oacute}ria e registro.`nO progresso deixa de ser sensa${ccedilla}${atilde}o`npara virar trof${eacute}u compartilh${aacute}vel." -Font $bodyFont -Brush $silverBrushSlide -X 176 -Y 676 -Width 728 -Height 236
...
Draw-CenterText -Graphics $graphics -Text "Produto 05  |  O Legado" -Font $eyebrowFont -Brush $eyebrowBrush -X 240 -Y 1060 -Width 600 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 05  |  O LEGADO" -Font ([System.Drawing.Font]::new($headlineFamily, 44, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
