param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\filosofia-12-clareza-sem-confronto\\slides"
)
...
Draw-CenterText -Graphics $graphics -Text "Clareza sem confronto`né autoengano elegante." -Font $heroTitleFont -Brush $marfimTitleBrush -X 140 -Y 302 -Width 800 -Height 314
Draw-CenterText -Graphics $graphics -Text "Muita lucidez aparente é só conforto intelectual bem vestido." -Font $bodyFont -Brush $offWhiteBrush -X 158 -Y 670 -Width 764 -Height 132
Draw-Pill -Graphics $graphics -Text "Filosofia 12" -Font $bodyBoldFont -X 404 -Y 824 -Width 272 -Height 54
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgMarfim -Width $width -Height $height -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Confronto" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 122 -Width 912 -Height 168
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 700 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Sem fricção,`na mente se absolve." -Font $titleLargeFont -Brush $marfimTitleBrush -X 184 -Y 300 -Width 712 -Height 196
Draw-CenterText -Graphics $graphics -Text "Quando nada te testa, qualquer narrativa serve.`nVocê chama de clareza o que talvez seja só falta de prova." -Font $bodyFont -Brush $offWhiteBrush -X 180 -Y 540 -Width 720 -Height 248
Draw-CenterText -Graphics $graphics -Text "Sem choque, o ego edita a verdade." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 838 -Width 728 -Height 120
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgMarfim -Width $width -Height $height -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Prova" -Font $watermarkFont -Brush $goldWashBrush -X 80 -Y 118 -Width 920 -Height 176
Draw-EditorialPanel -Graphics $graphics -X 128 -Y 246 -Width 824 -Height 708 -Tone "marfim"
Draw-CenterText -Graphics $graphics -Text "Ideia limpa`nnão basta.`nEla precisa resistir." -Font $titleLargeFont -Brush $marfimTitleBrush -X 176 -Y 294 -Width 728 -Height 198
Draw-CenterText -Graphics $graphics -Text "Clareza real atravessa conflito, limite e consequência.`nO que sobrevive ao confronto deixa de ser pose." -Font $bodyFont -Brush $offWhiteBrush -X 176 -Y 560 -Width 728 -Height 222
Draw-CenterText -Graphics $graphics -Text "O que resiste pode guiar." -Font $titleMediumFont -Brush $whiteBrush -X 186 -Y 848 -Width 708 -Height 112
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Filosofia 12  |  Progresso sem registro vira ilusao" -Font $eyebrowFont -Brush $eyebrowBrush -X 132 -Y 1060 -Width 816 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FILOSOFIA 12  |  CLAREZA SEM CONFRONTO E AUTOENGANO ELEGANTE" -Font ([System.Drawing.Font]::new($headlineFamily, 34, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
