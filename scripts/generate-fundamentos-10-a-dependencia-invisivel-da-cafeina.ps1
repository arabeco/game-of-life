param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-10-a-dependencia-invisivel-da-cafeina\slides"
)
...
$coverSupport = "Nem sempre o café é problema.`n�?s vezes ele só mascara outro."
...
Draw-CenterText -Graphics $graphics -Text "A Dependência Invisível da Cafeína" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 10  |  A DEPENDÊNCIA INVISÍVEL DA CAFEÍNA" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
