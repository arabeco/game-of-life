param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-05-a-arte-da-antecipaa-a-o\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-05-a-arte-da-antecipaa-a-o\assets"
...
$quoteText = "A suprema arte`nda guerra Ã© derrotar`no inimigo sem lutar."
$supportCore = "O estrategista que ensinou o mundo a vencer antes do confronto."
$analysis1Title = "O que Viktor Frankl fez?"
$analysis1 = "Sun Tzu condensou estratÃ©gia, leitura de terreno, timing e economia de forÃ§a num corpo de pensamento que atravessou sÃ©culos.`nSeus princÃ­pios saÃ­ram do campo de guerra e entraram em polÃ­tica, negÃ³cios e tomada de decisÃ£o."
$analysis1Close = "Ele ensinou a vitÃ³ria antes do choque."
$analysis2Title = "Por que isso foi raro?"
$analysis2Body = "Porque quase todos confundem forÃ§a com choque.`nSun Tzu organizou a ideia de que inteligÃªncia, leitura e preparaÃ§Ã£o podem decidir antes da luta comeÃ§ar."
$analysis2Close = "Ele ensinou o valor de vencer antes do ruÃ­do."
...
Draw-Pill -Graphics $graphics -Text "Legado 05  |  Sun Tzu" -Font $bodyBoldFont -X 318 -Y 188 -Width 444 -Height 54
Draw-CenterText -Graphics $graphics -Text "A Arte da`nAntecipaÃ§Ã£o" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $graphics -Text "Legado 05  |  Sun Tzu" -Font $eyebrowFont -Brush $eyebrowBrush -X 178 -Y 1060 -Width 724 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 05  |  A ARTE DA ANTECIPAÃ§Ã£O" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
