param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-09-o-doce-estrategico\slides"
)
...
$coverSupport = "Não é sobre demonizar prazer.`n�? sobre parar de ser governado por ele."
...
Draw-CenterText -Graphics $graphics -Text "O Doce Estratégico" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 09  |  O DOCE ESTRATÉGICO" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
