...
Draw-CenterText -Graphics $graphics -Text "Treinava rea${ccedilla}${atilde}o, clareza, linguagem`ne filosofia at${eacute} a disciplina`nvirar identidade." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
