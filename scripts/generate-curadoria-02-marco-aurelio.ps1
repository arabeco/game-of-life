...
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} nostalgia.`n${Eacute} disciplina em sistema." -Font $titleMediumFont -Brush $offWhiteBrush -X 110 -Y 1002 -Width 600 -Height 120
...
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgRubi -Width $width -Height $height -Tone "rubi"
Draw-CenterText -Graphics $graphics -Text "Marco Aur${eacute}lio" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
Draw-CenterText -Graphics $graphics -Text "O Imp${eacute}rio`ncome${ccedilla}a por dentro." -Font $titleLargeFont -Brush $goldBrushSlide -X 126 -Y 194 -Width 610 -Height 160
Draw-ClippedImageBox -Graphics $graphics -ImagePath $cr7Slide3Path -X 758 -Y 146 -Width 184 -Height 246 -Opacity 0.98 -AlignBottom
Draw-StatCard -Graphics $graphics -X 118 -Y 434 -Width 260 -Height 420 -Title "Espa${ccedilla}o mental`n10" -Body "Mente blindada`ncontra o caos`ndo maior imp${eacute}rio." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 410 -Y 434 -Width 260 -Height 420 -Title "Prop${oacute}sito`n10" -Body "Dever acima`ndo ego.`nPoder como miss${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 702 -Y 434 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "A rotina virou`ngoverno de si`nantes do mundo." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-CenterText -Graphics $graphics -Text "Espa${ccedilla}o mental, Prop${oacute}sito e Trabalho.`nO estoicismo virou estrutura de comando." -Font $bodyFont -Brush $mutedBrush -X 168 -Y 930 -Width 744 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgRubi -Width $width -Height $height -Tone "rubi"
Draw-CenterText -Graphics $graphics -Text "Marco Aur${eacute}lio" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 126 -Width 896 -Height 120
...
Draw-CenterText -Graphics $graphics -Text "O estoicismo n${Atilde}o ${eacute} teoria.`n${Eacute} sistema de execu${ccedilla}${atilde}o sob press${atilde}o." -Font $bodySmallFont -Brush $offWhiteBrush -X 204 -Y 1022 -Width 672 -Height 78
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Curadoria 02  |  Marco Aur${eacute}lio" -Font $eyebrowFont -Brush $eyebrowBrush -X 220 -Y 1060 -Width 640 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "CURADORIA 02  |  MARCO AUR${Eacute}LIO" -Font ([System.Drawing.Font]::new($headlineFamily, 46, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
