...
Draw-CenterText -Graphics $graphics -Text "Amador precisa ser visto.`nElite precisa ficar pronta." -Font $bodyFont -Brush $offWhiteBrush -X 170 -Y 720 -Width 740 -Height 116
...
Draw-CenterText -Graphics $graphics -Text "Se a energia vem da plateia, o padrão some no silêncio.`nEvolução séria não pode depender de testemunha." -Font $bodyFont -Brush $offWhiteBrush -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Vaidade atrasa. Treino cala." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 844 -Width 728 -Height 110
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Os melhores constroem força longe do elogio.`nQuando aparece a vitrine, o trabalho já está feito." -Font $bodyFont -Brush $offWhiteBrush -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "O invisível sustenta o extraordinário." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 856 -Width 728 -Height 112
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
