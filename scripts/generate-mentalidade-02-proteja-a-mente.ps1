...
Draw-CenterText -Graphics $graphics -Text "Clareza n${atilde}o nasce por acidente.`nEla ${eacute} defendida." -Font $bodyFont -Brush $offWhiteBrush -X 214 -Y 694 -Width 652 -Height 84
