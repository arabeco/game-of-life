...
export const ACTIVE_GOLD_STORE_ITEMS = [
    ...
    { id: 'item_skin_2_003', name: 'AcadÃƒÂªmico', category: 'skin', tier: 2, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_2_003 },
    ...
    { id: 'item_skin_3_001', name: 'NÃƒÂ´made', category: 'skin', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_001 },
    { id: 'item_border_3_001', name: 'ImparÃƒÂ¡vel', category: 'border', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_border_3_001 },
    { id: 'item_skin_3_002', name: 'Alquimista', category: 'skin', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_002 },
    { id: 'item_banner_imparavel', name: 'ImparÃƒÂ¡vel', category: 'banner', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_imparavel },
    { id: 'item_skin_3_003', name: 'HÃƒÂ­brido', category: 'skin', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_003 },
    { id: 'item_plate_3_001', name: 'Placa Prata', category: 'plate', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_plate_3_001 },
    { id: 'item_border_t3_mistico', name: 'MÃƒÂ­stico', category: 'border', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_border_t3_mistico },
    { id: 'item_banner_t3_mistico', name: 'MÃƒÂ­stico', category: 'banner', tier: 3, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_t3_mistico },
    ...
    { id: 'item_border_t4_guardia', name: 'GuardiÃƒÂ£', category: 'border', tier: 4, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_border_t4_guardia },
    { id: 'item_banner_t4_guardia', name: 'GuardiÃƒÂ£', category: 'banner', tier: 4, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_t4_guardia },
    { id: 'item_border_t4_oraculo', name: 'OrÃƒÂ¡culo', category: 'border', tier: 4, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_border_t4_oraculo },
    { id: 'item_banner_t4_oraculo', name: 'OrÃƒÂ¡culo', category: 'banner', tier: 4, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_t4_oraculo },
    ...
    { id: 'princesa', name: 'Princesa', category: 'hair', tier: 4, priceGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.princesa },
...
export const GOLD_CODEX_CATALOG = [
    ...
    { id: 'reset_dopaminergico', name: 'Reset DopaminÃƒÂ©rgico', priceGold: 350, source: 'sql' },
    { id: 'foco_blindado', name: 'Foco Blindado', priceGold: 500, source: 'sql' },
    { id: 'logistica_de_vanguarda', name: 'LogÃƒÂ­stica de Vanguarda', priceGold: 350, source: 'sql' },
...
export const GOLD_MECHANIC_CATALOG = [
    ...
    { id: 'relationship_invite_competicao', name: 'Convite de competiÃƒÂ§ÃƒÂ£o', priceGold: 50, source: 'sql' },
...
export const GOLD_CATALOG_NOTES = [
    'Pedido de amizade nÃƒÂ£o custa ouro.',
    'NÃƒÂ£o existe mais compra separada de slot de criaÃƒÂ§ÃƒÂ£o. A compra ativa jÃƒÂ¡ libera o uso.',
    'NÃƒÂ£o existe mais compra separada de capacidade social. O catÃƒÂ¡logo ativo nÃƒÂ£o lista slots.',
    ...
    'Empreendedor, Fundador e FÃƒÂªnix Dourada seguem fora da loja ativa por enquanto.',
] as const;
