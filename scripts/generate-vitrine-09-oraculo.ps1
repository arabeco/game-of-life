...
Draw-Pill -Graphics $graphics -Text "Vitrine 08" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
...
Draw-CenterText -Graphics $graphics -Text "Vitrine 08  |  Patentes de Vagante a Soberano" -Font $eyebrowFont -Brush $eyebrowBrush -X 144 -Y 1060 -Width 792 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "VITRINE 08  |  PATENTES DE VAGANTE A SOBERANO" -Font ([System.Drawing.Font]::new($headlineFamily, 38, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
