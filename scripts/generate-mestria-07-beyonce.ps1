...
Draw-CenterText -Graphics $graphics -Text "Sustenta d${eacute}cadas de entrega, controle criativo`ne presen${ccedilla}a de palco sem perder`ndire${ccedilla}${atilde}o nem centro." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
