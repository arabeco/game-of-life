...
Draw-CenterText -Graphics $graphics -Text "Não era só combate.`nEra estratégia, silêncio e precisão." -Font $titleMediumFont -Brush $offWhiteBrush -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Musashi não lutava`nsó por vitória." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 24) -Y ($slide2PanelY + 28) -Width ($slide2PanelWidth - 48) -Height 128
Draw-CenterText -Graphics $graphics -Text "Transformou disciplina, observação e frieza`nem vantagem antes do confronto começar." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 26) -Y ($slide2PanelY + 176) -Width ($slide2PanelWidth - 52) -Height 194
Draw-CenterText -Graphics $graphics -Text "Estratégia virou arma.`nClareza virou domínio." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 28) -Y ($slide2PanelY + 404) -Width ($slide2PanelWidth - 56) -Height 110
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Espaço mental`n10" -Body "Calma para ler`nritmo, vazio e`nmovimento sem`nentrar em ruído." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Treino brutal até`no fundamento virar`nresposta imediata." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Físico`n10" -Body "Corpo afiado para`nsustentar técnica,`npresença e impacto." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
...
Draw-CenterText -Graphics $graphics -Text "Miyamoto Musashi operava em disciplina,`nleitura, combate e dire${ccedilla}${atilde}o absoluta." -Font $bodySmallFont -Brush $offWhiteBrush -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
