param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-07-a-curiosidade-como-bussola\slides"
)
...
$assetRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\legado-07-a-curiosidade-como-bussola\assets"
...
$quoteText = "A imaginação é mais`nimportante que o conhecimento."
$supportCore = "O físico que mexeu na ideia de tempo, espaço e realidade."
$analysis1Title = "O que Albert Einstein fez?"
...
$analysis2Body = "Porque não basta ser inteligente: é preciso ver o que ninguém estava conseguindo formular.`nEinstein abriu uma nova arquitetura mental para interpretar o real."
...
Draw-CenterText -Graphics $graphics -Text "A Curiosidade como Bússola" -Font $heroTitleFont -Brush $goldBrushSlide -X 180 -Y 262 -Width 720 -Height 174
...
Draw-CenterText -Graphics $contactGraphics -Text "LEGADO 07  |  A CURIOSIDADE COMO BÚSSOLA" -Font ([System.Drawing.Font]::new($headlineFamily, 28, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
