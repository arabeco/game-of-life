param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\mestria-15-nelson-mandela\\slides"
)
...
$round6MestriaRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round15\\mestria"
$round6FallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round15"
...
Draw-CenterText -Graphics $graphics -Text "Não era só resistência.`nEra visão, disciplina e altura moral." -Font $titleMediumFont -Brush $silverBrushSlide -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Nelson Mandela" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 90 -Y 128 -Width 900 -Height 120
$slide2PanelX = 118
$slide2PanelY = 334
...
Draw-CenterText -Graphics $graphics -Text "Mandela não mudou`nsó um regime." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Transformou dor, clareza e propósito`nem liderança capaz de sustentar reconciliação." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Princípio virou força.`nSacrifício virou direção." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-CenterText -Graphics $graphics -Text "Nelson Mandela" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
Draw-CenterText -Graphics $graphics -Text "Consciência,`npropósito e eixo." -Font $titleLargeFont -Brush $goldBrushSlide -X 120 -Y 232 -Width 626 -Height 176
Draw-ClippedImageBox -Graphics $graphics -ImagePath $cr7Slide3Path -X 738 -Y 184 -Width 214 -Height 254 -Opacity 0.98 -AlignBottom
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Consciência`n10" -Body "Leitura alta de si,`ndo tempo e do peso`nde cada escolha." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Espaço mental`n10" -Body "Calma para manter`ndireção sem se`ncurvar ao caos." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Propósito`n10" -Body "Missão maior que`no ego, mantida por`ndécadas inteiras." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "Consciência, Espaço Mental e Propósito.`nMandela liderava de dentro para fora." -Font $bodyFont -Brush $mutedBrush -X 150 -Y 964 -Width 780 -Height 104
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Nelson Mandela operava em princ${iacute}pio, foco,`nsacrif${iacute}cio e constru${ccedilla}${atilde}o hist${oacute}rica." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mestria 10  |  Nelson Mandela" -Font $eyebrowFont -Brush $eyebrowBrush -X 148 -Y 1060 -Width 784 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 15  |  NELSON MANDELA" -Font ([System.Drawing.Font]::new($headlineFamily, 40, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
