...
export const ITEMS_DB: ItemDef[] = [
    // --- SKINS ---
    // T1 (Comum)
    { id: 'item_skin_1_001', name: 'NÃ¡ufrago', category: 'skin', tier: 1, rarity: 'common', icon: 'ðŸï¸', imageUrl: avatarPngAsset('SKIN_T1_NAUFRAGO'), description: "Trajes desgastados pelo tempo e pelo mar. Ideal para quem estÃ¡ comeÃ§ando sua jornada do zero.", isRankExclusive: true },
    { id: 'item_skin_1_002', name: 'Casual', category: 'skin', tier: 1, rarity: 'common', icon: 'ðŸ‘•', imageUrl: avatarPngAsset('SKIN_T1_CASUAL'), description: "Roupas confortÃ¡veis para o dia a dia. Nada de especial, mas cumpre o papel.", isRankExclusive: true },
    { id: 'item_skin_1_003', name: 'Gym Rat', category: 'skin', tier: 1, rarity: 'common', icon: 'ðŸ’ª', imageUrl: avatarPngAsset('SKIN_T1_GYM_RAT'), description: "Focado no treino e na disciplina fÃ­sica. O suor Ã© o seu melhor acessÃ³rio.", costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_1_003 },
    { id: 'item_skin_1_004', name: 'Street', category: 'skin', tier: 1, rarity: 'common', icon: 'ðŸ›¹', imageUrl: avatarPngAsset('SKIN_T1_STREET'), description: "Estilo urbano para quem domina as ruas e o asfalto.", isRankExclusive: true },
    // T2 (Incomum)
    { id: 'item_skin_2_001', name: 'Executivo', category: 'skin', tier: 2, rarity: 'uncommon', icon: 'ðŸ’¼', imageUrl: avatarPngAsset('SKIN_T2_EXECUTIVO'), isRankExclusive: true },
    { id: 'item_skin_2_002', name: 'TÃ¡tico', category: 'skin', tier: 2, rarity: 'uncommon', icon: 'ðŸ•¶ï¸', imageUrl: avatarPngAsset('SKIN_T2_TATICO'), isRankExclusive: true },
    { id: 'item_skin_2_003', name: 'AcadÃªmico', category: 'skin', tier: 2, rarity: 'uncommon', icon: 'ðŸŽ“', imageUrl: avatarPngAsset('SKIN_T2_ACADEMICO'), costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_2_003 },
    // T3 (Raro)
    { id: 'item_skin_3_001', name: 'NÃ´made', category: 'skin', tier: 3, rarity: 'rare', icon: 'ðŸª', imageUrl: avatarPngAsset('SKIN_T3_NOMADE'), costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_001 },
    { id: 'item_skin_3_002', name: 'Alquimista', category: 'skin', tier: 3, rarity: 'rare', icon: 'âš—ï¸', imageUrl: avatarPngAsset('SKIN_T3_ALQUIMISTA'), costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_002 },
    { id: 'item_skin_3_003', name: 'HÃ­brido', category: 'skin', tier: 3, rarity: 'rare', icon: 'ðŸ¤–', imageUrl: avatarPngAsset('SKIN_T3_HIBRIDO'), costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_3_003 },
    // T4 (Ã‰pico)
    { id: 'item_skin_4_001', name: 'Armadura Placa', category: 'skin', tier: 4, rarity: 'epic', icon: 'ðŸ›¡ï¸', imageUrl: avatarPngAsset('SKIN_T4_ARMADURA_PLACA'), costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_skin_4_001 },
    { id: 'item_skin_4_002', name: 'Mago CÃ­rculo', category: 'skin', tier: 4, rarity: 'epic', icon: 'ðŸ§™â€â™‚ï¸', imageUrl: avatarPngAsset('SKIN_T4_MAGO_CIRCULO'), isRankExclusive: true },
    // T5 (LendÃ¡rio)
    ...
    // T1
    { id: 'item_artifact_1_001', name: 'Adaga Aprendiz', category: 'artifact', tier: 1, rarity: 'common', icon: 'ðŸ—¡ï¸', imageUrl: avatarPngAsset('artefato_t1_adagaaprendiz') },
    { id: 'item_artifact_1_002', name: 'Cachorro Beagle', category: 'artifact', tier: 1, rarity: 'common', icon: 'ðŸ•', imageUrl: avatarPngAsset('artefato_t1_cachorrobeagle') },
    { id: 'item_artifact_1_003', name: 'Gato Laranja', category: 'artifact', tier: 1, rarity: 'common', icon: 'ðŸˆ', imageUrl: avatarPngAsset('artefato_t1_gatolaranja') },
    { id: 'item_artifact_1_004', name: 'Halteres', category: 'artifact', tier: 1, rarity: 'common', icon: 'ðŸ‹ï¸', imageUrl: avatarPngAsset('artefato_t1_halterespar') },
    { id: 'item_artifact_1_005', name: 'Trio CafÃ©', category: 'artifact', tier: 1, rarity: 'common', icon: 'â˜•', imageUrl: avatarPngAsset('artefato_t1_triocafe'), isRankExclusive: true },
    // T2
    { id: 'item_artifact_2_001', name: 'Cachorro Husky', category: 'artifact', tier: 2, rarity: 'uncommon', icon: 'ðŸº', imageUrl: avatarPngAsset('artefato_t2_cachorrohusky') },
    { id: 'item_artifact_2_002', name: 'Gato SiamÃªs', category: 'artifact', tier: 2, rarity: 'uncommon', icon: 'ðŸ±', imageUrl: avatarPngAsset('artefato_t2_gatosiames') },
    { id: 'item_artifact_2_003', name: 'Setup', category: 'artifact', tier: 2, rarity: 'uncommon', icon: 'ðŸ’»', imageUrl: avatarPngAsset('artefato_t2_setup'), isRankExclusive: true },
    // T3
    { id: 'item_artifact_3_001', name: 'Cachorro Jack', category: 'artifact', tier: 3, rarity: 'rare', icon: 'ðŸ¶', imageUrl: avatarPngAsset('artefato_t3_cachorrojack') },
    { id: 'item_artifact_3_002', name: 'Caixa MÃ¡gica', category: 'artifact', tier: 3, rarity: 'rare', icon: 'ðŸ“¦', imageUrl: avatarPngAsset('ARTEFATO_T3_caixamagica') },
    { id: 'item_artifact_3_003', name: 'Cetro Esmeralda', category: 'artifact', tier: 3, rarity: 'rare', icon: 'ðŸª„', imageUrl: avatarAsset('ARTEFATO_T3_cetroesmeralda.png') },
    { id: 'item_artifact_3_004', name: 'Coroa Prata', category: 'artifact', tier: 3, rarity: 'rare', icon: 'ðŸ‘‘', imageUrl: avatarPngAsset('ARTEFATO_T3_coroaprata') },
    { id: 'item_artifact_3_005', name: 'Divine Scepter', category: 'artifact', tier: 3, rarity: 'rare', icon: 'âšœï¸', imageUrl: avatarPngAsset('artefato_t3_DivineScepter') },
    { id: 'item_artifact_3_006', name: 'Espada Runas', category: 'artifact', tier: 3, rarity: 'rare', icon: 'âš”ï¸', imageUrl: avatarAsset('ARTEFATO_T3_espadarunas.png') },
    // T4
    { id: 'item_artifact_4_001', name: 'Coroa de Espinhos', category: 'artifact', tier: 4, rarity: 'epic', icon: 'ðŸŒµ', imageUrl: avatarPngAsset('ARTEFATO_T4_COROA_ESPINHOS') },
    { id: 'item_artifact_4_002', name: 'DragÃ£o BebÃª', category: 'artifact', tier: 4, rarity: 'epic', icon: 'ðŸ‰', imageUrl: avatarPngAsset('ARTEFATO_T4_DRAGAO_BEBE'), isRankExclusive: true },
    { id: 'item_artifact_4_003', name: 'GrimÃ³rio Arcano', category: 'artifact', tier: 4, rarity: 'epic', icon: 'ðŸ“–', imageUrl: avatarPngAsset('ARTEFATO_T4_GRIMORIO_ARCANO') },
    { id: 'item_artifact_4_004', name: 'Manta', category: 'artifact', tier: 4, rarity: 'epic', icon: 'ðŸ§£', imageUrl: avatarPngAsset('artefato_t4_manta') },
    // T5
    { id: 'item_artifact_5_001', name: 'FÃªnix CÃ³smico', category: 'artifact', tier: 5, rarity: 'legendary', icon: 'ðŸ¦', imageUrl: avatarPngAsset('ARTEFATO_T5_FENIX_COSMICO') },
    { id: 'item_artifact_5_002', name: 'Tesseract', category: 'artifact', tier: 5, rarity: 'legendary', icon: 'ðŸ§Š', imageUrl: avatarPngAsset('ARTEFATO_T5_tessaract') },
    ...
    { id: 'item_banner_t3_mistico', name: 'MÃ­stico', category: 'banner', tier: 3, rarity: 'rare', icon: 'ðŸ”®', imageUrl: `${INTERFACE_BASE_URL}/banner_t3_mistico.png`, costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_banner_t3_mistico },
    { id: 'item_banner_vanguarda_01', name: 'Banner Vanguarda', category: 'banner', tier: 3, rarity: 'rare', icon: 'ðŸš©', imageUrl: `${INTERFACE_BASE_URL}/banner_vanguarda.png`, isRankExclusive: true },
    ...
    // --- AURAS ---
    // T1
    catalogItem('aura', { id: 'item_aura_1_001', name: 'Bruma', tier: 1, rarity: 'common', icon: 'ðŸŒ«ï¸' }),
    catalogItem('aura', { id: 'item_aura_1_002', name: 'Safira', tier: 1, rarity: 'common', icon: 'ðŸ”¹' }),
    catalogItem('aura', { id: 'item_aura_1_003', name: 'Rubi', tier: 1, rarity: 'common', icon: 'ðŸ”»' }),
    // T2
    catalogItem('aura', { id: 'item_aura_2_001', name: 'Esmeralda', tier: 2, rarity: 'uncommon', icon: 'â‡ï¸' }),
    catalogItem('aura', { id: 'item_aura_2_002', name: 'Prata', tier: 2, rarity: 'uncommon', icon: 'âšª' }),
    // T3
    catalogItem('aura', { id: 'item_aura_3_001', name: 'Ouro', tier: 3, rarity: 'rare', icon: 'ðŸŸ¡' }),
    // T5
    catalogItem('aura', { id: 'item_aura_5_001', name: 'Pedra da Lua', tier: 5, rarity: 'legendary', icon: 'ðŸŒ™' }),
    catalogItem('aura', { id: 'item_aura_5_002', name: 'Multiverso', tier: 5, rarity: 'legendary', icon: 'ðŸŒŒ' }),
    ...
    { id: 'item_orb_2_003', name: 'Orbe Tempestade', category: 'orb', tier: 2, rarity: 'uncommon', icon: 'ðŸŒ©ï¸', imageUrl: `${GLYPHS_BASE_URL}/ORBE_T2_TEMPESTADE.png`, costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_orb_2_003 },
    // T3
    { id: 'item_orb_3_001', name: 'Orbe de Ouro', category: 'orb', tier: 3, rarity: 'rare', icon: 'ðŸª™', imageUrl: `${GLYPHS_BASE_URL}/ORBE_T3_OURO.png`, costGold: ACTIVE_GOLD_ITEM_PRICE_BY_ID.item_orb_3_001 },
...
export const CODEXES = [
    ...
    { id: "codex_financas", name: "Campanha: FinanÃ§as Pessoais", cost: 150, icon: 'ðŸ’°' },
    { id: "codex_produtividade", name: "Campanha: Produtividade Extrema", cost: 150, icon: 'âš¡' },
    { id: "codex_saude", name: "Campanha: SaÃºde & Fitness", cost: 150, icon: 'ðŸ‹ï¸' },
    { id: "codex_mindset", name: "Campanha: Mindset de Sucesso", cost: 150, icon: 'ðŸ§ ' }
];
