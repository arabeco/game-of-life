param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\produto-13-codex\\slides",
    [string]$Screen1Path = "",
    [string]$Screen2Path = ""
)
...
$proofRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round13\\produto"
$proofFallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\\round13"
...
Draw-CenterText -Graphics $graphics -Text "Codex" -Font $watermarkFont -Brush $goldWashBrush -X 84 -Y 132 -Width 912 -Height 180
Draw-CenterText -Graphics $graphics -Text "Método bom`nprecisa caber`nna rotina." -Font $heroTitleFont -Brush $goldBrushSlide -X 134 -Y 332 -Width 812 -Height 246
Draw-CenterText -Graphics $graphics -Text "No GLYPH, metodologia não fica em PDF esquecido.`nEla entra no fluxo e vira execução." -Font $bodyFont -Brush $offWhiteBrush -X 142 -Y 652 -Width 796 -Height 196
Draw-Pill -Graphics $graphics -Text "Produto 13" -Font $bodyBoldFont -X 292 -Y 858 -Width 224 -Height 52
Draw-Pill -Graphics $graphics -Text "Codex" -Font $bodyBoldFont -X 536 -Y 858 -Width 248 -Height 52
...
$graphics = $canvas.Graphics
Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgSapphire -Width $width -Height $height -Tone "safira"
Draw-CenterText -Graphics $graphics -Text "Método" -Font $watermarkFont -Brush $goldWashBrush -X 86 -Y 118 -Width 908 -Height 180
...
Draw-CenterText -Graphics $graphics -Text "Mentoria,`nsequência e uso." -Font $titleLargeFont -Brush $goldBrushSlide -X 196 -Y 384 -Width 688 -Height 236
Draw-CenterText -Graphics $graphics -Text "Cada Codex organiza uma lógica de ação pronta.`nVocê instala, entende e aplica sem reinventar tudo." -Font $bodyFont -Brush $offWhiteBrush -X 176 -Y 676 -Width 728 -Height 236
Draw-CenterText -Graphics $graphics -Text "Conhecimento só vale quando entra no dia." -Font $titleSmallFont -Brush $whiteBrush -X 174 -Y 936 -Width 732 -Height 84
...
for ($proofPage = 0; $proofPage -lt $proofPageCount; $proofPage++) {
    ...
    $graphics = $canvas.Graphics
    Draw-BackgroundBase -Graphics $graphics -BackgroundPath $bgSapphire -Width $width -Height $height -Tone "safira"
    Draw-CenterText -Graphics $graphics -Text "Telas reais de`nCodex e Método." -Font $titleLargeFont -Brush $goldBrushSlide -X 124 -Y 150 -Width 832 -Height 110
...
Draw-CenterText -Graphics $graphics -Text "Produto 13  |  Clas, quests e operacao coletiva" -Font $eyebrowFont -Brush $eyebrowBrush -X 148 -Y 1060 -Width 784 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "PRODUTO 13  |  CODEX" -Font ([System.Drawing.Font]::new($headlineFamily, 38, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
