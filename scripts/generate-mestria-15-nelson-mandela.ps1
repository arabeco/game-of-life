...
Draw-CenterText -Graphics $graphics -Text "Transformou dor, clareza e propósito`nem liderança capaz de sustentar reconciliação." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
