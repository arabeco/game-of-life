...
Draw-CenterText -Graphics $graphics -Text "Transformou t${eacute}cnica, coragem e voz`np${uacute}blica em uma for${ccedilla}a`nimposs${iacute}vel de ignorar." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
