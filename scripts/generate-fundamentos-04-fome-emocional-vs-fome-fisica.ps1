param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-04-fome-emocional-vs-fome-fisica\slides"
)
...
$coverSupport = "Nem todo desejo por comida é energia.`n�?s vezes é fuga."
...
Draw-CenterText -Graphics $graphics -Text "Fome Emocional vs. Fome Física" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 04  |  FOME EMOCIONAL VS. FOME FÍSICA" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
