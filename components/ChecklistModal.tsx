...
type ChecklistTab = 'checklist' | 'sequence' | 'journal';
                ...
                >
                    <div className="flex items-center justify-between gap-3">
                        <div>
                            ...
                            <p className="mt-1 text-xs text-white/45">Checklist do dia, sequências e o diário.</p>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-2 rounded-2xl border border-white/8 bg-black/25 p-1">
                        <button
                            type="button"
                        ...
                        <button
                            ...
                            className={`rounded-[1rem] px-3 py-2 text-xs font-black uppercase tracking-[0.12em] transition-colors ${
                                activeTab === 'journal'
                                    ? 'bg-white/10 text-white shadow-[0_8px_18px_rgba(0,0,0,0.24)]'
                                    : 'text-white/45 hover:text-white/75'
                            }`}
