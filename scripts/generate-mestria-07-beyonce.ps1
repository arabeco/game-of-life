param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\mestria-07-beyonce\slides"
)
...
$round6MestriaRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round7\mestria"
$round6FallbackRoot = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round7"
...
if ($round6MestriaAssets.Count -lt 3) {
    throw "Mestria 07 precisa de 3 imagens em marketing\\round7\\mestria ou marketing\\round7."
}
...
Draw-CenterText -Graphics $graphics -Text "Beyonce" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
...
Draw-CenterText -Graphics $graphics -Text "Como o Glyph`nleria`nBeyonce?" -Font $titleHugeFont -Brush $goldBrushSlide -X 94 -Y 392 -Width 592 -Height 448
Draw-Pill -Graphics $graphics -Text "N${Iacute}vel de maestria 88" -Font $bodyBoldFont -X 186 -Y 860 -Width 392 -Height 56
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} s${oacute} talento.`n${Eacute} comando, repeti${ccedilla}${atilde}o e reinven${ccedilla}${atilde}o." -Font $titleMediumFont -Brush $silverBrushSlide -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Beyonce" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 90 -Y 128 -Width 900 -Height 120
$slide2PanelX = 118
$slide2PanelY = 334
...
Draw-CenterText -Graphics $graphics -Text "Ela n${Atilde}o sustenta`ns${oacute} imagem." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 150
Draw-CenterText -Graphics $graphics -Text "Sustenta d${eacute}cadas de entrega, controle criativo`ne presen${ccedilla}a de palco sem perder`ndire${ccedilla}${atilde}o nem centro." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
Draw-CenterText -Graphics $graphics -Text "Performance virou sistema.`nImagem virou arquitetura." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 420) -Width ($slide2PanelWidth - 40) -Height 112
...
Draw-CenterText -Graphics $graphics -Text "Beyonce" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 92 -Y 128 -Width 896 -Height 120
Draw-CenterText -Graphics $graphics -Text "Radar de uma`nexecutora rara." -Font $titleLargeFont -Brush $goldBrushSlide -X 120 -Y 232 -Width 626 -Height 176
Draw-ClippedImageBox -Graphics $graphics -ImagePath $cr7Slide3Path -X 738 -Y 184 -Width 214 -Height 254 -Opacity 0.98 -AlignBottom
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Entrega extrema`nsem depender`nde fase." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Projetos`n10" -Body "Musica, turn${ecirc}, imagem`ne dire${ccedilla}${atilde}o sob`numa s${oacute} vis${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Conex${otilde}es`n9" -Body "Impacto cultural`nsem perder centro`nnem assinatura." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "Trabalho, Projetos e Conex${otilde}es.`nO palco era s${oacute} a ponta do sistema." -Font $bodyFont -Brush $mutedBrush -X 150 -Y 964 -Width 780 -Height 104
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
$values = @(8,9,6,10,10,9,9,10,7,10)
...
Draw-CenterText -Graphics $graphics -Text "Beyonce opera em camadas:`nvoz, palco, imagem, dire${ccedilla}${atilde}o e longevidade." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mestria 07  |  Beyonce" -Font $eyebrowFont -Brush $eyebrowBrush -X 218 -Y 1060 -Width 644 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 07  |  BEYONCE" -Font ([System.Drawing.Font]::new($headlineFamily, 46, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
