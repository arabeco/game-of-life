...
export const LEGACY_BACKDROP_SKINS: LegacyBackdropSkin[] = [
    {
        ...
        overlay: 'linear-gradient(180deg, rgba(0,0,0,0.04), rgba(0,0,0,0.12))',
    ...
    },
    {
        ...
        overlay: 'linear-gradient(180deg, rgba(14,10,5,0.03), rgba(20,16,10,0.09))',
    ...
    },
    {
        ...
        overlay: 'linear-gradient(180deg, rgba(0,0,0,0.04), rgba(0,0,0,0.13))',
