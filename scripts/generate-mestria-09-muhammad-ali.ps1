...
Draw-CenterText -Graphics $graphics -Text "Arnold n${Atilde}o venceu`ns${oacute} no f${iacute}sico." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 24) -Y ($slide2PanelY + 28) -Width ($slide2PanelWidth - 48) -Height 128
Draw-CenterText -Graphics $graphics -Text "Transformou corpo, carreira, dinheiro`ne narrativa p${uacute}blica em`num mesmo projeto de poder." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 26) -Y ($slide2PanelY + 176) -Width ($slide2PanelWidth - 52) -Height 194
Draw-CenterText -Graphics $graphics -Text "Disciplina virou identidade.`nEscala virou m${eacute}todo." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 28) -Y ($slide2PanelY + 404) -Width ($slide2PanelWidth - 56) -Height 110
