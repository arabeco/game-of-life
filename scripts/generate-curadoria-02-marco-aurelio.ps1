param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\curadoria-02-marco-aurelio\slides"
)
...
function Draw-ClippedImageBox {
    ...
    try {
        $Graphics.SetClip($clipRect)
        Draw-ImageInBox -Graphics $Graphics -ImagePath $ImagePath -X $X -Y $Y -Width $Width -Height $Height -Opacity $Opacity -Cover:$Cover -AlignBottom:$AlignBottom -AlignRight:$AlignRight
    } finally {
        $Graphics.Restore($state)
    }
}
...
$cr7CoverPath = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round2\image-removebg-preview - 2026-03-18T193814.395.png"
$cr7PanelPath = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round2\image-removebg-preview - 2026-03-18T191913.833.png"
$cr7Slide3Path = "C:\Users\Afonso\Downloads\GOL1.006\marketing\round2\image-removebg-preview - 2026-03-18T191817.431.png"
...
Draw-CenterText -Graphics $graphics -Text "Como o Glyph`nleria Marco`nAur${eacute}lio?" -Font $titleHugeFont -Brush $goldBrushSlide -X 104 -Y 402 -Width 560 -Height 430
Draw-Pill -Graphics $graphics -Text "N${Iacute}vel de maestria 90" -Font $bodyBoldFont -X 186 -Y 860 -Width 392 -Height 56
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} nostalgia.`n${Eacute} disciplina em sistema." -Font $titleMediumFont -Brush $silverBrushSlide -X 100 -Y 980 -Width 620 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Marco Aur${eacute}lio" -Font $curadoriaWatermarkFont -Brush $curadoriaWatermarkBrush -X 90 -Y 128 -Width 900 -Height 120
$slide2PanelX = 150
$slide2PanelY = 362
...
Draw-CenterText -Graphics $graphics -Text "Roma n${Atilde}o foi`ngovernada por`nimpulso." -Font $titleMediumFont -Brush $goldBrushSlide -X ($slide2PanelX + 18) -Y ($slide2PanelY + 24) -Width ($slide2PanelWidth - 36) -Height 152
Draw-CenterText -Graphics $graphics -Text "Marco Aur${eacute}lio enfrentou guerra,`npress${atilde}o e caos pol${iacute}tico`nsem terceirizar o pr${oacute}prio centro." -Font $bodyFont -Brush $silverBrushSlide -X ($slide2PanelX + 20) -Y ($slide2PanelY + 188) -Width ($slide2PanelWidth - 40) -Height 188
Draw-CenterText -Graphics $graphics -Text "Estoicismo n${Atilde}o ${eacute} pose.`n${Eacute} governo interno." -Font $titleMediumFont -Brush $whiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 390) -Width ($slide2PanelWidth - 40) -Height 96
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "Espa${ccedilla}o mental`n10" -Body "Mente blindada`ncontra o caos`ndo maior imp${eacute}rio." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Prop${oacute}sito`n10" -Body "Dever acima`ndo ego.`nPoder como miss${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "A rotina virou`ngoverno de si`nantes do mundo." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $silverBrushSlide
Draw-CenterText -Graphics $graphics -Text "Espa${ccedilla}o mental, Prop${oacute}sito e Trabalho.`nO estoicismo virou estrutura de comando." -Font $bodyFont -Brush $mutedBrush -X 168 -Y 968 -Width 744 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
$values = @(10,10,9,10,8,9,7,10,7,10)
...
Draw-CenterText -Graphics $graphics -Text "O estoicismo n${Atilde}o ${eacute} teoria.`n${Eacute} sistema de execu${ccedilla}${atilde}o sob press${atilde}o." -Font $bodySmallFont -Brush $silverBrushSlide -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Mestria 02  |  Marco Aur${eacute}lio" -Font $eyebrowFont -Brush $eyebrowBrush -X 220 -Y 1060 -Width 640 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "MESTRIA 02  |  MARCO AUR${Eacute}LIO" -Font ([System.Drawing.Font]::new($headlineFamily, 46, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
