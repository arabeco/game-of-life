param(
    [string]$OutputDir = "C:\Users\Afonso\Downloads\GOL1.006\marketing\fundamentos-02-o-ritual-de-descompressa-o-noturna\slides"
)
...
$coverSupport = "O dia nÃ£o termina sozinho.`nO corpo precisa ser avisado."
$logic1Title = "Sem um ritual de saÃ­da,`na mente continua em turno."
$logic1Body = "Tela forte, luz alta e microestÃ­mulos mantÃªm o cÃ©rebro em estado de alerta.`nSe vocÃª encerra o dia no mesmo ritmo em que trabalhou, o corpo deita, mas nÃ£o desliga."
$logic1Close = "Sono ruim comeÃ§a antes da cama."
$logic2Title = "DescompressÃ£o`nÃ© transiÃ§Ã£o."
$logic2Body = "Luz mais baixa, banho, skincare, silÃªncio e reduÃ§Ã£o de tela criam uma mensagem clara: o expediente acabou.`nO sistema nervoso entende contexto antes de entender discurso."
...
Draw-CenterText -Graphics $graphics -Text "O Ritual de`nDescompressÃ£o`nNoturna" -Font $heroTitleFont -Brush $goldBrushSlide -X 126 -Y 314 -Width 828 -Height 252
Draw-CenterText -Graphics $graphics -Text $coverSupport -Font $bodyFont -Brush $offWhiteBrush -X 152 -Y 566 -Width 776 -Height 144
Draw-Pill -Graphics $graphics -Text "Fundamentos 02" -Font $bodyBoldFont -X 386 -Y 790 -Width 308 -Height 54
...
Draw-CenterText -Graphics $graphics -Text "Fundamentos 02  |  Descanso falso vs. descanso real" -Font $eyebrowFont -Brush $eyebrowBrush -X 98 -Y 1060 -Width 884 -Height 28
...
Draw-CenterText -Graphics $contactGraphics -Text "FUNDAMENTOS 02  |  O RITUAL DE DESCOMPRESSÃ£O NOTURNA" -Font ([System.Drawing.Font]::new($headlineFamily, 26, [System.Drawing.FontStyle]::Bold, [System.Drawing.GraphicsUnit]::Pixel)) -Brush $sheetGold -X 180 -Y 42 -Width 1240 -Height 60
