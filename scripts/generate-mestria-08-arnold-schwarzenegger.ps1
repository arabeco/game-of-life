...
Draw-CenterText -Graphics $graphics -Text "N${Atilde}o ${eacute} s${oacute} for${ccedilla}a.`n${Eacute} estrat${eacute}gia, imagem e expans${atilde}o." -Font $titleMediumFont -Brush $offWhiteBrush -X 94 -Y 980 -Width 642 -Height 142
...
Draw-CenterText -Graphics $graphics -Text "Transformou corpo, carreira, dinheiro`ne narrativa p${uacute}blica em`num mesmo projeto de poder." -Font $bodyFont -Brush $offWhiteBrush -X ($slide2PanelX + 20) -Y ($slide2PanelY + 182) -Width ($slide2PanelWidth - 40) -Height 224
...
Draw-StatCard -Graphics $graphics -X 118 -Y 468 -Width 260 -Height 420 -Title "F${iacute}sico`n10" -Body "O corpo virou`nplataforma de`nmaestria e prova." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 410 -Y 468 -Width 260 -Height 420 -Title "Trabalho`n10" -Body "Repeti${ccedilla}${atilde}o brutal`nat${eacute} a execu${ccedilla}${atilde}o`nvirar padr${atilde}o." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
Draw-StatCard -Graphics $graphics -X 702 -Y 468 -Width 260 -Height 420 -Title "Projetos`n10" -Body "Cinema, neg${oacute}cios`ne pol${iacute}tica sem`nmentalidade de`nsegunda arena." -TitleFont $titleCardFont -BodyFont $bodyFont -GoldBrush $goldBrushSlide -BodyBrush $offWhiteBrush
...
Draw-CenterText -Graphics $graphics -Text "Arnold expandiu o pr${oacute}prio radar:`nfor${ccedilla}a, carreira, capital e influ${ecirc}ncia." -Font $bodySmallFont -Brush $offWhiteBrush -X 170 -Y 1012 -Width 740 -Height 96
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
