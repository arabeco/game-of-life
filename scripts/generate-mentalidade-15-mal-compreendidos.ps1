...
Draw-CenterText -Graphics $graphics -Text "Visão longa quase sempre parece estranha no começo." -Font $bodyFont -Brush $offWhiteBrush -X 170 -Y 720 -Width 740 -Height 116
...
Draw-CenterText -Graphics $graphics -Text "Ansiedade por validação empurra decisões curtas.`nÉ assim que muita grandeza morre ainda pequena." -Font $bodyFont -Brush $offWhiteBrush -X 162 -Y 520 -Width 756 -Height 228
Draw-CenterText -Graphics $graphics -Text "Pressa por aceitação encurta destino." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 844 -Width 728 -Height 110
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
...
Draw-CenterText -Graphics $graphics -Text "Nem toda visão consegue ser explicada no primeiro minuto.`nOs melhores aceitam isso e seguem construindo." -Font $bodyFont -Brush $offWhiteBrush -X 162 -Y 558 -Width 756 -Height 210
Draw-CenterText -Graphics $graphics -Text "Nem toda verdade nasce popular." -Font $titleMediumFont -Brush $whiteBrush -X 176 -Y 856 -Width 728 -Height 112
Draw-SmallBrand -Graphics $graphics -LogoPath $logoPath -Font $ctaFont -Brush $goldSoftBrush
