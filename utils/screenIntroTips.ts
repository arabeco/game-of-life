...
export const SCREEN_INTRO_TIPS: Record<ScreenIntroTipId, ScreenIntroTipDef> = {
  assets: {
    ...
    summary: 'Aqui eu vejo quais areas estão fortes, cansadas ou pedindo atenção.',
  ...
  action_modal: {
    ...
    summary: 'Escreva algo que você realmente consegue fazer. Curto, claro e executável.',
  ...
  rest: {
    ...
    summary: 'Essa tela reduz o ruido e mostra o que importa sem te jogar em mil botões.',
    items: ['se o dia já teve uma conclusão, fecha com calma. Se não teve, pega uma ação pequena.'],
  },
  social: {
    id: 'social',
    label: 'Mundo',
  ...
  social_people: {
    ...
    summary: 'Use esta area para buscar pessoas, ver vínculos e cuidar da sua rede.',
    items: ['procure alguém ou revise quem já esta no seu círculo.'],
  },
  social_requests: {
    id: 'social_requests',
    label: 'Pedidos',
    title: 'Tudo que espera resposta.',
    summary: 'Convites e solicitações ficam separados para não virar bagunca no chat.',
  ...
  social_clan: {
    ...
    summary: 'Use esta area para acompanhar conversa, presença e combinados do clã.',
  ...
  store: {
    ...
    items: ['uma aba por vez. Campanha muda estrutura; item muda presença.'],
  },
  store_codexes: {
    id: 'store_codexes',
    label: 'Codexes',
  ...
  store_items: {
    ...
    items: ['compre so o que você quer ver no seu perfil ou inventário.'],
  },
  store_gold: {
    id: 'store_gold',
    label: 'Ouro',
  ...
  season: {
    ...
    summary: 'A temporada mostra missões, recompensas e desafios vivos deste período.',
    items: ['pegue uma missão pequena e leve para suas arenas ou planner.'],
  },
  arsenal: {
    id: 'arsenal',
    label: 'Arsenal',
    title: 'Seu inventário mora aqui.',
    summary: 'Tudo que você ganhou, comprou ou equipou aparece nesta area.',
    items: ['abra artefatos ou cosméticos e equipe o que combina com você.'],
  },
  settings: {
    id: 'settings',
    label: 'Config',
    title: 'Ajuste o app ao seu jeito.',
    summary: 'Aqui ficam conta, privacidade, som, Oráculo, tutoriais e preferência de uso.',
    items: ['mude uma preferência por vez; não precisa configurar tudo agora.'],
  },
  settings_general: {
    id: 'settings_general',
    label: 'Geral',
    title: 'O básico da conta.',
  ...
  settings_preferences: {
    ...
    summary: 'Aqui você ajusta visual, som, vibração, dicas e o quanto eu apareco.',
  ...
  profile: {
    ...
    items: ['confere visual e privacidade antes de deixar alguém ver.'],
  },
  reports: {
    id: 'reports',
    label: 'Relatorios',
...
const SCREEN_INTRO_TIP_VARIANTS: Partial<Record<ScreenIntroTipId, (state: ScreenIntroTipState) => Partial<ScreenIntroTipDef> | null>> = {
  arenas: (state) => (state.arenasCount === 0 ? null : {
    title: 'Uma frente por vez.',
    summary: `Você já tem ${state.arenasCount} ${state.arenasCount === 1 ? 'arena' : 'arenas'}. Aqui elas viram o que você joga hoje.`,
